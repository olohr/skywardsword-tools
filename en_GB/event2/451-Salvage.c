          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0 */ "I have identified the item that the...\nhighly unusual man on Fun Fun Island\nsays was lost.\n\nWe can call the Scrap Shop robot to\ncome and retrieve it. Would you like me\nto call the robot?\n[1]Yes![2-]No, thanks.")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x05Master, I will send word to the robot\nusing telepathic transmission.")
          	  case 1:
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0 */ "Yes, \x0E\x01\x12\x04\x00\x05Master. If you change your mind\nand decide to retrieve it, please\nexamine it again.")
          	}
          }

          void entrypoint_451_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dMistress Fi, zrrpt! You called?\n\n\n\nWhoa, zrrft... This place seems\nstrangely familiar, brrzrrt...\n\n\nBzzzt, so you want me to carry this\nthing?")
          }
...
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x01Master, I suggest that we head back to\nthe sky and return this party wheel to\nits owner as soon as possible.")
