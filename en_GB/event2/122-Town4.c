...
/*<133>*/ 	switch (story_flags[375 /* us: 805A9B02 0x20, jp: 805ACD82 0x20 */]) {
          	  case 0:
/*<134>*/ 		printf(/* textboxtype: 1, unk: 0 */ "With the fortune-teller back on the job,\nthis place feels alive again. It's just\nnot the same without him.")
          	  case 1:
