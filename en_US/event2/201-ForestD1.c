...
/*<208>*/ 		printf(/* textboxtype: 2, unk: 0 */ "I recommend using the \x0E\x02\x04\x02\x19CD on your\nmap as a guide when revisiting the\ndeepest area of the temple.")
