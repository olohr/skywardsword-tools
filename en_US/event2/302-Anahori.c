...
/*<154>*/ 			printf(/* textboxtype: 1, unk: 0 */ "The name's <b<Tubert>>. Nice to meet you! \nI run this little game I like to call\n<r<Thrill Digger>>!")
...
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Here's your grand Rupee total: <r<\x0E\x02\x03\x06\x00\x00Í>>!")
