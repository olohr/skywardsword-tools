...
/*< 43>*/ 	switch (story_flags[21 /* us: 805A9ADB 0x20, jp: 805ACD5B 0x20 */]) {
          	  case 0:
/*< 44>*/ 		printf(/* textboxtype: 1, unk: 0 */ "La vue est magnifique, ici !")
          	  case 1:
...
/*< 51>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 24)])) {
          		  case 0:
/*< 52>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Oh, mais c'est...\x0E\x01\x04\x02\x1E Va tout de suite\nl'apporter au <b<dragon de foudre >>!")
          		  case 1:
...
/*< 37>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\x900On a planté une <r<pousse de l'arbre de vie\n>>là\x2010bas, pour que le dragon de foudre\npuisse guérir grâce à son fruit...")
          				  ...
          				  case 1:
/*<  8>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\xC00C'est terrible ! Le <b<dragon de foudre\n>>est malade...~~~\n\n\n\x0E\x01\x09\x04\x03\xC00Pour utiliser les chronolithes du coin,\nil faut l'autorisation du dragon...\x0E\x01\x04\x02\x1E\n\x0E\x01\x09\x04\x01\xC00Mais ce n'est pas vraiment ça\nle problème le plus urgent !")
          				}
          			}
          		}
          	}
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Si tu te dépêches pas, tu vas\npas y arriver !")
          	  case 1:
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Le dragon de foudre est de bonne\nhumeur.")
          		  case 1:
...
/*< 57>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 28)])) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Oh, que comptes\x2010tu faire de ce fruit ?\x0E\x01\x04\x02-\nTu vas l'apporter au <b<dragon de\nfoudre >>?")
          		  case 1:
...
/*< 63>*/ 			switch (has_rupees(10)) {
          			  case 0:
/*< 64>*/ 				rupees += -10;
/*< 66>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F02\x208Merci ! Tu verras, tu n'as pas investi\nen vain.")
