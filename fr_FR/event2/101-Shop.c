...
/*<140>*/ 				loadzone_temp_flags[1 /* 0x1 02 */] = true;
          		  ...
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x07Oh, je vois, tu es si intelligent, si avisé,\nque je n'ai même pas besoin de te\nrenseigner !\n\nRegarde donc mes merveilleux articles.")
...
/*< 73>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x02Voilà un <y<petit sac de graines >>!\nAvec cela, tu peux stocker 10 graines\nMojo supplémentaires.\n\nL'accessoire indispensable à tous les\nadeptes du lance\x2010pierre !\n\n\nIl coûte <r<100 rubis>>. Presque rien,\nen somme !\n[1]J'achète[2-]Non merci")
          		goto flw_33
          	  case 1:
/*< 82>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Je suis au regret de constater que tu\nn'as pas de lance\x2010pierre, donc je ne\npeux te vendre cet article...\n\nMais tu trouveras ton bonheur parmi\nmes autres articles, j'en suis sûr !\nEncore désolé, toutes mes excuses !")
          	}
          }
...
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x08Mais que...\x0E\x01\x05\x04\n\x00")
/*< 60>*/ 	OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 6), ('param2', 512), ('next', 61), ('param3', 22)])
/*< 61>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Quel petit plaisantin tu fais ! Tu n'as\npas assez de rubis pour acheter ceci,\nvoyons ! Haha !")
...
/*<136>*/ 				loadzone_temp_flags[5 /* 0x1 20 */] = false;
          	  ...
          	  case 1:
/*< 42>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x07Aaah... C'est toujours une joie de\nfaire affaire avec toi !")
          		goto flw_144
          	}
          }
