...
/*< 23>*/ 	start()
/*< 24>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, Fay\nau rapport. Je confirme que l'entrée\nd'une épreuve se trouve dans les\nalentours.\nUne fois que vous aurez <r<détecté>>\nson emplacement, le <b<Courage de\nFarore >>que vous avez appris sur\nl'île aux chants vous guidera.")
/*< 42>*/ 	story_flags[818 /* us: 805A9B30 0x04, jp: 805ACDB0 0x04 */] = true;
          }

          void entrypoint_006_007() {
/*< 37>*/ 	start()
/*< 38>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au\nrapport. Je confirme que l'éruption\nvolcanique a cessé.\n\nVous pouvez désormais retourner\ndans le ciel.")
...
/*< 49>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, Fay\nau rapport. Je confirme que l'entrée\nd'une épreuve se trouve dans les\nalentours.\nUne fois que vous aurez <r<détecté>>\nson emplacement, le <b<Courage de\nFarore >>que vous avez appris sur\nl'île aux chants vous guidera.")
