...
/*< 34>*/ 	start()
/*< 35>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Oho...~~~ Je vois que tu ne te débrouilles\npas trop mal.\n\n\nMais tu n'as pas vraiment de mérite...~~~\nTu ne le dois qu'à cette épée.")
          }
...
/*< 46>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Ah, la poisse ! C'était bien la peine que\nje m'embête à chaparder cette clé à\nces satanés monstres...")
...
/*< 54>*/ 		printf(/* textboxtype: 1, unk: 0 */ "On m'la fait pas à moi !\nTu empestes le trésor à des\nkilomètres.")
          		goto flw_61
          	}
          }
...
/*< 67>*/ 	printf(/* textboxtype: 1, unk: 0 */ "C'est pas vrai... Je me suis embêté\nà venir jusqu'ici pour rien. J'ai\nvraiment pas de bol.")
...
/*< 71>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Bon, moi, je vais rentrer.\nÀ la poche pleine !")
...
/*<126>*/ 		printf(/* textboxtype: 1, unk: 0 */ "On se connaît, non ?\nOuais, ça me revient, on s'est\ncroisés au volcan, c'est ça ?")
...
/*<153>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Toi aussi t'es venu parce que t'as\nentendu les histoires du type qui\nressemble à un gros caillou ?\n[1]Le Goron ?[2]Des histoires ?")
/*<134>*/ 			OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 4369), ('param2', 3339), ('next', 135), ('param3', 13)])
/*<135>*/ 			printf(/* textboxtype: 1, unk: 0 */ "C'est moi qui trouverai le\ntrésor en premier !")
...
/*<130>*/ 			printf(/* textboxtype: 1, unk: 0 */ "On m'la fait pas à moi !\nTu empestes le trésor à des\nkilomètres.")
          			goto flw_152
          		}
          	}
          }
...
/*<176>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Ouais ! C'est cette clé !\nT'es allé la chercher\nexprès pour moi ?")
          			goto flw_182
          		}
          	  case 1:
...
/*<235>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Ah, la poisse ! C'était bien la peine que\nje m'embête à chaparder cette clé à\nces satanés monstres...")
...
/*< 39>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 2, unk: 0 */ "Les sbires de Ghirahim ont verrouillé\nla porte à nouveau. Il faut en retrouver\nla clé.")
