...
/*< 84>*/ 				switch (temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*< 85>*/ 					printf(/* textboxtype: 1, unk: 1 */ "\x0E\x01\x09\x04\x00\x02Tu veux encore faire du tir à la\ncitrouille ? Ça te coûtera<r< 20 rubis>>.\n[1]D'accord ![2]C'est quoi,\nles règles ?[3-]Non merci")
          					flw_74:
/*< 74>*/ 					switch (choice(3)) {
          					  case 0:
          						flw_67:
/*< 67>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*< 68>*/ 							rupees += -20;
/*< 70>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\xA0AAlors, c'est parti !\nCourage, Link !")
...
/*<115>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\xA00Tu crois que tu arriverais\nà marquer au moins <r<600 points>> ?\nJ'aimerais beaucoup voir ça !")
          			goto flw_91
          		  case 3:
...
/*< 34>*/ 			switch (choice(2)) {
          			  case 0:
/*< 35>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\xA0BOh, merci ! Alors, je t'explique...")
