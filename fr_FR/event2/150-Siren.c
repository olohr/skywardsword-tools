...
/*< 33>*/ 			printf(/* textboxtype: 2, unk: 2 */ "Vous vous trouvez dans le monde de la\ndernière épreuve, la <b<Psysalis de la\nDéesse>>.")
/*< 37>*/ 			set_camera(9, 0)
