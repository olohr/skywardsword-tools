          void entrypoint_510_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0 */ "Voici l'<r<hélice du moulin >>que nous\ncherchions.\n\n\nIl est possible de l'emporter à l'aide du\nrobot de l'atelier de rénovation.\n\n\nDois\x2010je l'appeler ?\n[1]Oui[2-]Non")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x05Très bien, Maître. J'appelle le robot\npar ondes psychiques.<pling>")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x05Très bien, Maître. Examinez\x2010la à\nnouveau si vous voulez l'emmener.")
          	}
          }

          void entrypoint_510_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dDame Fay de mon c\x153ur à moi !\nTu m'attendais, n'est\x2010ce pas ?\n\n\nOh, c'est ça qu'il faut porter ?")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dBon, je l'emmène dans le ciel,\nvenez vite me rejoindre !")
          }

          void entrypoint_510_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x01Maître, je vous recommande de\nretourner dans le ciel immédiatement\npour emmener l'hélice à destination.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dHé, le maître en vert, tu vois pas que\ntu gênes ? Pousse\x2010toi un peu de là !")
          }
