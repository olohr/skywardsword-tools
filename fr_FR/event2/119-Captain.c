...
/*<147>*/ 								set_camera(11, 0)
/*<146>*/ 								printf(/* textboxtype: 1, unk: 0 */ "Pouah ! C'est infect !\x0E\x01\x04\x02\x14\nLa soupe est glaciale...")
...
/*< 22>*/ 			switch (scene_flags[59 /* 0x6 08 */]) {
          			  case 0:
/*< 14>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x09Ouah ! \x0E\x03\x01\x00Link !\nQuel beau bouclier tu as là !\n\x0E\x01\x09\x04\x19\x200Alors, passons aux choses sérieuses.\n\nLa <r<défense >>: <r<mouvements de base >>!")
          				flw_15:
/*< 15>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1C\x200<g<Donne un coup sec avec le\nNunchuk >>pour brandir ton <r<bouclier>>.\nC'est aussi simple que ça !\n\n\x0E\x01\x09\x04\x0E\x200Pour baisser ton bouclier, <g<brandis\nton épée en donnant un coup avec\nla télécommande Wii>>.\nAppuie sur (A) pour tout ranger.\n\x0E\x01\x09\x04\x08\x200Mais reste prudent car <g<sortir ton épée\n>>te fait <r<baisser ta garde >>!")
/*< 16>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x09\x1D00Essaie déjà ça !")
