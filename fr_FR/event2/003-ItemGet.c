...
/*<227>*/ 	start()
/*<528>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu la <y<carte marine\nancienne >>! Elle représente la mer qui\ns'étendait autrefois à la place du\ndésert.")
...
/*<191>*/ 	start()
/*<172>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu une <y<potion de soin \x2605\x2605 >>!\nUn flacon contient <r<deux doses >>de ce\nprécieux breuvage qui <r<vous restaure\ntous vos c\x153urs>>.")
          }
...
/*< 15>*/ 	start()
/*<  1>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu de la <y<Protectine >>!\nCette étrange potion diminue de moitié\nles dégâts subis. Son effet ne dure que\n<r<trois minutes>>.")
          }

          void entrypoint_003_048() {
/*<101>*/ 	start()
/*< 43>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu <r<un >><y<cristal de gratitude >>!\nIl semble qu'une personne au c\x153ur\ndébordant de reconnaissance soit\npassée par ici...\nRassemblez\x2010en plusieurs et apportez\x2010les\nà<b< Morcego >>!")
...
/*<504>*/ 		printf(/* textboxtype: 5, unk: 1 */ "Vous avez récupéré la <y<vraie épée de\nlégende >>! Vous allez enfin pouvoir laisser\néclater votre colère ! Gare à celui qui se\ndressera sur votre route !\nDe plus, vous allez à nouveau pouvoir\nparler avec <pling><b<Fay>> !")
...
/*<382>*/ 	start()
/*<380>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu la <y<cage à insecte >>!\nL'insecte bien\x2010aimé de Terry se trouve\nà l'intérieur ! Hâtez\x2010vous de le lui\nrapporter !")
          }
...
/*< 10>*/ 	start()
          	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu de la <y<Protectine \x2605 >>!\nCette potion extrêmement puissante\nvous protège de tout dégât pendant\n<r<trois minutes >>!")
          }
...
/*<405>*/ 	switch (story_flags[161 /* us: 805A9AE3 0x01, jp: 805ACD63 0x01 */]) {
          	  case 0:
/*<406>*/ 		printf(/* textboxtype: 5, unk: 1 */ "Vous avez récupéré la <y<jarre magique >>!\nVous allez pouvoir faire un peu\nde ménage !")
...
/*< 89>*/ 	start()
/*< 32>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu l'<y<écaille du dragon\nd'eau >>! C'est une des reliques de la Déesse.\nElle vous permet de nager sous l'eau\net de tourbillonner.")
...
/*<510>*/ 		OrderedDict([('type', 'type3'), ('subType', 0), ('param1', 0), ('param2', 1), ('next', -1), ('param3', 34)])
          	  case 1:
/*<513>*/ 		printf(/* textboxtype: 5, unk: 1 */ "L'emplacement des coffres est également\nindiqué. Prenez le temps d'y jeter un \x153il !")
...
/*<187>*/ 	start()
/*<168>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu de l'<y<Endurol \x2605 >>!\nCe philtre miraculeux empêche votre\njauge d'endurance de se vider pendant\n<r<trois minutes>> !")
          }
...
/*<598>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 96)])) {
          		  case 0:
/*<599>*/ 			printf(/* textboxtype: 5, unk: 1 */ "Vous avez récupéré le <y<lance\x2010pierre rafale>><y< >>!\nHébétez les patrouilles ennemies !\n")
          			flw_433:
...
/*<390>*/ 	start()
/*<388>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu le <y<sceau des épreuves >>!\nCette pierre mènera le héros à\nl'endroit où repose la Triforce.")
...
/*<506>*/ 	switch (has_empty_bottle()) {
          	  case 0:
/*<507>*/ 		printf(/* textboxtype: 5, unk: 1 */ "Vous avez attrapé une <y<fée >>!\nCette créature bienveillante\nvous rendra <r<six >>c\x153urs !\n\nMalheureusement, vous n'avez\npas de <y<flacon vide>>. Vous allez\ndevoir la laisser partir.")
          	  case 1:
/*<505>*/ 		printf(/* textboxtype: 5, unk: 1 */ "Vous avez trouvé une <y<fée >>!\nCes créatures bienveillantes\nvous rendent <r<six>> c\x153urs !")
          	}
          }
...
/*<106>*/ 	start()
/*< 48>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu <y<cinq bombes >>!\nVous pouvez les jeter ou les faire rouler\npour détruire des matériaux résistants.\nRavitaillez\x2010vous dès que possible !")
          }
...
/*<140>*/ 	start()
/*< 81>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu un <y<c\x153ur >>!\nChacun d'eux est un concentré d'énergie\nrégénératrice qui restaure votre jauge\nde vie d'<r<un>> c\x153ur.")
          }
...
/*<199>*/ 			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 10)])) {
          			  case 0:
/*<208>*/ 				printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter\nvotre énergie vitale maximale d'un c\x153ur.\nPlus qu'<r<un >>!")
          			  case 1:
/*<200>*/ 				printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter\nvotre énergie vitale maximale d'un c\x153ur.\nPlus que <r<deux >>!")
          			}
          		  case 1:
/*<203>*/ 			printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter\nvotre énergie vitale maximale d'un c\x153ur.\nPlus que <r<trois >>!")
          		}
          	  case 1:
/*<207>*/ 		printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu un <y<fragment de c\x153ur >>!\nVous avez formé un nouveau réceptacle\nde c\x153ur. Votre énergie vitale maximale\naugmente d'un c\x153ur !")
          	}
          }
...
/*< 91>*/ 	start()
/*< 34>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu <y<dix >><y<<y<graines <y<Mojo >>!\nVous pouvez lancer ces petites\ngraines avec votre lance\x2010pierre.\nGardez un \x153il sur vos réserves !")
          }
...
/*<194>*/ 	start()
/*<175>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu une <y<potion de soin >>!\nLorsque vous la buvez, vous récupérez\n<r<huit c\x153urs>> !")
          }
...
/*<119>*/ 	start()
/*< 60>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu la <y<<y<statuette tentaculaire<y< >>!\nCette statuette à la forme peu commune\nest recouverte d'inquiétantes ventouses...")
          }

          void entrypoint_003_079() {
/*<193>*/ 	start()
/*<174>*/ 	printf(/* textboxtype: 5, unk: 1 */ "Vous avez obtenu une <y<potion de soin \x2605 >>!\nCette version améliorée de la potion de\nsoin <r<vous restaure tous vos c\x153urs>>.")
          }
