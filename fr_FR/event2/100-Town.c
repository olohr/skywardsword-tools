...
/*<142>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\xE06Si tu as un problème avec ton\noiseau, va voir <b<Kiko>>. Je l'ai vu au\nrez\x2010de\x2010chaussée tout à l'heure.\nSi tu allais lui demander conseil ?")
...
/*<193>*/ 					switch (story_flags[552 /* us: 805A9B16 0x02, jp: 805ACD96 0x02 */]) {
          					  case 0:
          					  case 1:
/*<190>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\xD57Comment ? Tu as quelque chose\nà me dire ? Ça peut pas attendre\ndemain...?")
...
/*<134>*/ 			set_camera(13, 0)
/*< 78>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\xC16Visiblement, <b<Hergo>> s'est arrangé pour\nle faire taire.")
...
/*< 89>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\xC00\x819Pardon, Link ! Je ne suis\nqu'un poltron... Je suis vraiment\ndésolé.")
...
/*<101>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0C\xC05Si tu vas du côté de la cascade, tu\ndevrais prendre une <r<épée>>. Il y a des\ncréatures inquiétantes qui rôdent par\nlà\x2010bas.\n\x0E\x01\x09\x04\x09\xC00Le <b<capitaine des chevaliers>> est entré\ndans la salle d'escrime tout à l'heure.\nSi tu allais lui demander de te prêter\nune épée ?")
          }
...
/*<103>*/ 	switch (scene_flags[55 /* 0x7 80 */]) {
          	  case 0:
/*<105>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\xC00\x800\x0E\x01\x06\x02\xFBCD... \x0E\x01\x06\x02Í\x0E\x03\x01\x00Link... Tu pourras le\nretrouver à temps ?\n\n\n\x0E\x01\x09\x04\xC00\xE06Je ne suis qu'un misérable\x0E\x01\x06\x02\xFBCD...\x0E\x01\x06\x02Í Pardon.")
          	  case 1:
...
/*<225>*/ 			switch (story_flags[11 /* us: 805A9AD8 0x10, jp: 805ACD58 0x10 */]) {
          			  case 0:
/*<226>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Au fait, ça fait un moment que je n'ai\npas vu Hergo. Où est\x2010ce qu'il a bien pu\npasser ?")
          			  case 1:
/*<227>*/ 				switch (story_flags[140 /* us: 805A9AE7 0x04, jp: 805ACD67 0x04 */]) {
          				  case 0:
/*<228>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Alors, comment vas\x2010tu ?\nPuisque tu es là, profites\x2010en pour aller\npasser une bonne nuit de sommeil dans\nton <r<lit>>.")
          				  case 1:
