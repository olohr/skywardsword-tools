...
/*<221>*/ 	switch (scene_flags[73 /* 0x8 02 */]) {
          	  case 0:
/*<223>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Je suis sûr que ta copine t'attend,\nalors baisse pas les bras !")
          	  case 1:
/*<224>*/ 		scene_flags[4 'Eldin Volcano'][73 /* 0x8 02 */] = true;
/*<222>*/ 		printf(/* textboxtype: 1, unk: 1 */ "\x0E\x01\x09\x04\x00\x01Salut, toi ! Ça faisait un bail !\nMerci pour l'autre fois !\n\n\nAu fait, est\x2010ce que t'as retrouvé\nta copine ?\n[1]Oui[2]Pas encore")
/*<225>*/ 		switch (choice(2)) {
          		  case 0:
/*<227>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x11\x808Ah bon, tu l'as retrouvée !\nC'est cool, ça...\x0E\x01\x04\x02\x14 Oh ? T'as pas\nencore pu la sauver ?\n\n\x0E\x01\x09\x04\x09\x8FFBah, fais pas cette tête.\nJe suis sûr que tu finiras\npar y arriver ! Courage !")
          		  case 1:
/*<226>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x13\x100DJe vois...\nPeut\x2010être que les rougeauds l'ont...\x0E\x01\x04\x02\x14\n\n\n\x0E\x01\x09\x04\x11\x80EQuoi ? Tu sais qu'elle est encore\nen vie ? Alors tout va bien !\nFais pas cette tête !\n\n\x0E\x01\x09\x04\x09\x800Si tu baisses les bras, elle est fichue !\nAlors courage, mon gars !")
          		}
          	}
          }
...
/*< 65>*/ 		set_camera(5, 0)
/*< 64>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Alors faut pas toucher au barrage qui\nretient la lave là\x2010bas, c'est dangereux.\nAllez, à plus !")
          	}
          }
...
/*<240>*/ 		switch (scene_flags[74 /* 0x8 04 */]) {
          		  case 0:
/*<239>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x15\x80CMon flair me dit qu'il\ndevrait y en avoir dans\nle coin...")
          		  case 1:
...
/*< 26>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Une <r<clé>> ! <r<C\x2010L\x2010É >>!")
/*<148>*/ 	set_camera(24, 0)
...
/*< 31>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Mais...~~~ on a pas besoin de clé, il suffit\nde passer sous terre pour se retrouver\nà l'intérieur, non ?")
...
/*< 53>*/ 			printf(/* textboxtype: 1, unk: 1 */ "Tiens, alors maintenant, tu veux que\nje te révèle mes infos secrètes ?")
...
/*<307>*/ 			printf(/* textboxtype: 1, unk: 1 */ "\x0E\x01\x09\x04\x11\x8FFT'as une bonne tête, alors je te fais\nun prix d'ami. <r<20 rubis>>, c'est honnête,\nnon ?\n[1]Dis\x2010moi tout ![2-]Non merci")
          			goto flw_44
          		}
          	}
          }
...
/*<269>*/ 	start()
/*<268>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x05\x04Z\x00Faites attention à vos objets en <r<bois\n>>et à vos <r<vêtements>>. Ils sont facilement\ninflammables.")
          }
...
/*<109>*/ 			set_camera(-1, 0)
          			flw_137:
/*<137>*/ 			printf(/* textboxtype: 1, unk: 0 */ "J'espère que ta copine s'est pas fait\nattraper par ces sales rougeauds... ")
...
/*< 11>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Bon, ça suffit maintenant !\nOn vous laissera plus saccager\nnotre territoire ! Hein ?")
...
/*<119>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x08\x02\xFFCDJ'en reviens pas qu'il dise ça, plus planqué\nque lui, tu meurs !")
