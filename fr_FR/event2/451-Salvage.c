...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dFay adorée !\nTu m'as appelé ?\n\n\nC'est bizarre, cet endroit me rend\ntout nostalgique...\n\n\nCette fois, c'est ça qu'il faut\ntransporter ?")
          }

          void entrypoint_451_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dTrès bien, j'apporte ça dans le ciel.\nRejoignez\x2010moi vite !")
          }

          void entrypoint_451_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x01Maître, je vous conseille de regagner\nle ciel pour remettre la roulette à son\npropriétaire au plus vite.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dBon, toi, le maître en vert, reste\ntranquille. Laisse faire le pro !")
          }
