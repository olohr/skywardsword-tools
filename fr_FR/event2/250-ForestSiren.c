...
/*< 42>*/ 									switch (temp_flags[7 /* 0x1 80 */]) {
          									  case 0:
/*< 46>*/ 										printf(/* textboxtype: 2, unk: 2 */ "Les <r<gardiens>> qui vous attaquent\net les <r<veilleurs>> qui traquent les\nintrus peuvent être de deux\ntypes, <r<terrestre ou céleste>>.\nChacun a un comportement\ndifférent, faites\x2010y très attention.")
...
/*< 11>*/ 			printf(/* textboxtype: 2, unk: 2 */ "Vous voyez cet objet brillant\nen face de vous, \x0E\x01\x12\x04\x00\x02Maître ?")
/*< 12>*/ 			set_camera(3, 0)
