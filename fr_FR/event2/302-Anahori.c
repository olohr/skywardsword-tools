...
/*< 16>*/ 		switch (story_flags[180 /* us: 805A9AE6 0x08, jp: 805ACD66 0x08 */]) {
          		  case 0:
/*< 14>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Bienvenue, tu vois !")
...
/*< 59>*/ 						printf(/* textboxtype: 1, unk: 1 */ "C'est <r<30 rubis >>la partie, tu vois.\nTu veux jouer ?\n[1]Oui[2-]Non")
...
/*< 35>*/ 								printf(/* textboxtype: 1, unk: 0 */ "Tu n'as pas assez d'argent.\nReviens me voir quand tu\nauras de quoi payer, tu vois !")
          							}
          						  case 1:
/*< 75>*/ 							OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 0), ('next', 38), ('param3', 12)])
/*< 38>*/ 							printf(/* textboxtype: 1, unk: 1 */ "À quel niveau veux\x2010tu jouer, tu vois ?\n[1]Débutant[2]Intermédiaire[3]Expert[4-]Quitter")
          							goto flw_85
          						}
          					  case 1:
...
/*< 22>*/ 						printf(/* textboxtype: 1, unk: 1 */ "C'est <r<50 rubis>> la partie, tu vois.\nTu veux jouer ?\n[1]Oui[2-]Non")
...
/*< 29>*/ 								printf(/* textboxtype: 1, unk: 0 */ "Tu n'as pas assez d'argent.\nReviens me voir quand tu\nauras de quoi payer, tu vois !")
          							}
          						  case 1:
/*< 77>*/ 							OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 0), ('next', 32), ('param3', 12)])
/*< 32>*/ 							printf(/* textboxtype: 1, unk: 1 */ "À quel niveau veux\x2010tu jouer, tu vois ?\n[1]Débutant[2]Intermédiaire[3]Expert[4-]Quitter")
          							goto flw_85
          						}
          					  case 1:
...
/*< 23>*/ 						printf(/* textboxtype: 1, unk: 1 */ "C'est <r<70 rubis>> la partie, tu vois.\nTu veux jouer ?\n[1]Oui[2-]Non")
...
/*< 13>*/ 								printf(/* textboxtype: 1, unk: 0 */ "Tu n'as pas assez d'argent.\nReviens me voir quand tu\nauras de quoi payer, tu vois !")
          							}
          						  case 1:
/*< 79>*/ 							OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 0), ('next', 25), ('param3', 12)])
/*< 25>*/ 							printf(/* textboxtype: 1, unk: 1 */ "À quel niveau veux\x2010tu jouer, tu vois ?\n[1]Débutant[2]Intermédiaire[3]Expert[4-]Quitter")
          							goto flw_85
          						}
          					  case 1:
...
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Tu as déterré <r<<r<\x0E\x02\x03\x06\x00\x00Í<r< rubis>>, tu vois.")
...
/*< 56>*/ 						printf(/* textboxtype: 1, unk: 0 */ "Tu as l'air exténué, tu vois. Reviens me\nvoir quand tu auras repris des forces.")
/*<116>*/ 						set_camera(5, 0)
/*<117>*/ 						printf(/* textboxtype: 1, unk: 0 */ "Tu veux faire une pause ?\nAssieds\x2010toi en face de moi, tu vois.")
          					  case 1:
/*<  2>*/ 						printf(/* textboxtype: 1, unk: 1 */ "Alors, tu veux rejouer ?\nQuel niveau ?\n[1]Débutant[2]Intermédiaire[3]Expert[4-]Quitter")
          						goto flw_85
          					}
          				  case 1:
...
/*< 52>*/ 					story_flags[181 /* us: 805A9AE6 0x10, jp: 805ACD66 0x10 */] = true;
          			  ...
          			  case 1:
/*<  8>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Tu t'es fait dépouiller !\nJe suis désolé pour toi, tu vois.")
          				goto flw_103
          			  case 2:
/*< 43>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Tu as perdu un peu d'argent, tu vois.\nCe n'est pas ton jour de chance.")
          				flw_102:
...
/*<107>*/ 				OrderedDict([('type', 'type3'), ('subType', 0), ('param1', 0), ('param2', 0), ('next', 55), ('param3', 45)])
          		  ...
          		  case 1:
/*<  9>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Tu n'as rien perdu, mais\nrien gagné non plus, tu vois !")
          			goto flw_102
          		  case 2:
...
/*< 40>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Tu as déterré un sacré pactole !\nFélicitations, tu vois !")
          				goto flw_102
          			}
          		}
          	  case 2:
...
/*<130>*/ 			switch (loadzone_temp_flags[1 /* 0x1 02 */]) {
          			  case 0:
/*<131>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\xA05Non, je ne flotte pas, tu vois.\nJe suis assis sur ma queue pour que\nles clients admirent mes <r<coussinets>>.")
          				goto flw_128
          			  case 1:
/*<151>*/ 				set_camera(1, 0)
/*<148>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x14\x1605Non, je ne flotte pas, tu vois.\nJe suis assis sur ma queue.")
/*<152>*/ 				set_camera(2, 0)
...
/*<133>*/ 			switch (loadzone_temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*<135>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\xA09Non, je ne suis pas ébloui, tu vois.\nJe suis juste à la pointe de la mode.")
          				goto flw_128
          			  case 1:
/*<145>*/ 				set_camera(3, 0)
...
/*<146>*/ 				set_camera(4, 0)
/*<143>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x14\xE0BEt ma <r<moustache>>, pas mal, non ?\nElle est bien recourbée, tu vois.\nJe la peigne tous les matins.")
/*<147>*/ 				set_camera(-1, 0)
/*<144>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\xAFFJe dois être présentable\nauprès de mes clients, non ?\nC'est important, tu vois.")
