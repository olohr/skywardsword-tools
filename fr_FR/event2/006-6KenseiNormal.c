          void entrypoint_006_600() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0 */ "La cible verrouillée est un <b<lemly (jour)>>.<b<\x0E\x01\x0C\x04\x06\x259>>")
...
/*< 65>*/ 					switch (choice(2)) {
          					  case 0:
/*< 66>*/ 						printf(/* textboxtype: 2, unk: 0 */ "Si Ghirahim se saisit de votre épée,\ndégagez\x2010la en la levant <r<du côté de\nl'ouverture laissée par ses doigts>>.\n[1]Plus de\ndétails[2-]Ne me dis\npas tout !")
/*< 67>*/ 						switch (choice(2)) {
          						  case 0:
...
/*<245>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				flw_14:
/*< 14>*/ 				printf(/* textboxtype: 2, unk: 0 */ "Deux de ses <r<points faibles >>se cachent au\ncreux de ses pinces géantes. Portez vos\nattaques en prenant soin d'orienter vos\ncoups d'épée dans la bonne direction.[1]Plus de\ndétails[2-]Merci !")
/*< 19>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<179>*/ 	start()
/*<180>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<184>*/ 	start()
/*<185>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<189>*/ 	start()
/*<190>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<194>*/ 	start()
/*<195>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<199>*/ 	start()
/*<200>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<204>*/ 	start()
/*<205>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<209>*/ 	start()
/*<210>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
...
/*<214>*/ 	start()
/*<215>*/ 	printf(/* textboxtype: 2, unk: 0 */ "J'ai collecté de nouvelles données,\n\x0E\x01\x12\x04\x00\x0BMaître. Analyse du mode de\ncomportement de cet ennemi terminée.\n\nVoulez\x2010vous entendre mon rapport\nmaintenant ? [1]Oui[2-]Non")
