...
/*< 43>*/ 	switch (story_flags[21 /* us: 805A9ADB 0x20, jp: 805ACD5B 0x20 */]) {
          	  case 0:
/*< 44>*/ 		printf(/* textboxtype: 1, unk: 0 */ "La vue est magnifique, ici! Vrrzt!")
          	  case 1:
...
/*< 51>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 24)])) {
          		  case 0:
/*< 52>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Brrm, brrzt! Mais c'est...\x0E\x01\x04\x02\x1E Va tout de\nsuite l'apporter au <b<dragon de foudre>>!")
          		  case 1:
...
/*<135>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 46>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Grâce à toi, le dragon de foudre est\nguéri! Bvvzziit! Mille mercis!")
          		  case 1:
/*<136>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Tu es venu voir le dragon de foudre?\nBrrrzt?")
          		}
          	  case 1:
...
/*< 54>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 26)])) {
          		  case 0:
/*< 55>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Le dragon de foudre guérira s'il\nmange un <r<fruit de l'arbre de vie>>!\nVrrrrm!")
          		  case 1:
...
/*< 36>*/ 			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 14)])) {
          			  case 0:
/*< 38>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\xC00Il n'y a que de l'herbe et des fleurs qui\npoussent par ici...\x0E\x01\x04\x02\x1E \x0E\x01\x09\x04\x01\xC00Si on ne fait rien,<b<\x0E\x01\x06\x02\xFECD>> le\ndragon de foudre risque de... brrrzt...")
          			  case 1:
/*< 33>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*<168>*/ 					switch (scene_flags[23 /* 0x3 80 */]) {
          					  case 0:
/*<169>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x00Je suis si inquiet pour le dragon de\nfoudre... S'il te plaît, cherche le <r<fruit\nde l'arbre de vie>>! Bzzt!")
          					  case 1:
/*< 37>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\x900On a planté une <r<pousse de l'arbre de vie\n>>là\x2010bas, pour que le dragon de foudre\npuisse guérir grâce à son fruit... Vrrm.")
          					}
          				  case 1:
/*<  8>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\xC00C'est terrible! Brrztz! Le <b<dragon\nde foudre >>est malade...~~~Vrrrrm...\n\n\n\x0E\x01\x09\x04\x03\xC00Pour utiliser les chronolithes du coin,\nil faut l'autorisation du dragon...\x0E\x01\x04\x02\x1E Vrm.\n\x0E\x01\x09\x04\x01\xC00Mais ce n'est pas vraiment ça\nle problème le plus urgent!")
          				}
          			}
          		}
          	}
...
/*<151>*/ 	start()
/*<152>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F0C\xD01\x0E\x01\x06\x02\xFFCD\x0E\x01\x08\x02\x1CD\x0E\x01\x09\x04\x2F00\x01Hé! Toi là\x2010bas!\nTu es Link,\nn'est\x2010ce pas?\n\n\x0E\x01\x06\x02\xFFCD\x0E\x01\x08\x02\x1CDTu tombes à pic!~~~\nJe voulais te voir, justement.~~~\n\n\n\x0E\x01\x06\x02\x2CD\x0E\x01\x08\x02\x1CDViens donc par ici!")
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Si tu ne te dépêches pas, tu n'y\narriveras pas! Vzrrt!")
          	  case 1:
/*< 71>*/ 		OrderedDict([('type', 'type3'), ('subType', 0), ('param1', 0), ('param2', 0), ('next', 12), ('param3', 31)])
/*< 12>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\x900Ici, il y a plein de grands chronolithes.\x0E\x01\x04\x02\x1E\n\x0E\x01\x09\x04\x00\x900Toi aussi tu as reçu l'autorisation du\n<b<dragon de foudre>> pour venir ici? Vrm?\n\n\x0E\x01\x09\x04\x01\x900J'étais justement en train de lui en\napporter un. Bzzrt.")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x05\x04(\x00Ça grouille de monstres un peu\nplus loin! Vrrrm!~~~ \x0E\x01\x09\x04\x03\xC00Fais bien attenztzt...")
          	}
          }
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Le dragon de foudre est de très bonne\nhumeur. Brzzzrt!")
          		  case 1:
/*<137>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Le dragon de foudre est en\nbonne santé! Brrtzt!")
          		}
          	  case 1:
...
/*< 57>*/ 		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 28)])) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 1, unk: 0 */ "Brritzz! Que penses\x2010tu faire de ce\nbeau fruit?\x0E\x01\x04\x02- Tu vas l'apporter au\n<b<dragon de foudre>>? Vrrm?")
          		  case 1:
...
/*< 28>*/ 			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 8)])) {
          			  case 0:
/*< 39>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\xC00Les arbres poussent très mal ici, dans\nles <b<terres de Lanelle>>... Vrrrm.\x0E\x01\x04\x02\x1E\n\x0E\x01\x09\x04\x03\x900Il doit bien exister un endroit où ils\npoussent plus vite... Bzzrt!")
          			  case 1:
/*< 26>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*< 29>*/ 					printf(/* textboxtype: 1, unk: 0 */ "De l'autre côté du pont, nous avons\nplanté une <r<pousse de l'arbre de vie>>,\ndont les fruits guérissent tous les\nmaux. Vrrrrzt.\x0E\x01\x04\x02\x1E\n\x0E\x01\x09\x04\x00\xC00Mais les arbres poussent très mal ici...\nVrrrm.")
          				  case 1:
/*< 16>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x03\x900Avec l'autorisation du dragon de\nfoudre, vrzt, nous creusons ici à\nla recherche de <b<chronolithes>>.\n\n\x0E\x01\x04\x02\x1E\x0E\x01\x09\x04\x03\xC00Mais le <b<dragon >>est en mauvaise santé...~~~\nNous sommes inquiets pour lui. Vrrm...\x0E\x01\x04\x02\x1E\n\x0E\x01\x09\x04\x01\xC00Sa vie est en danger... Brrzzt!")
          				}
          			}
          		}
          	}
...
/*< 68>*/ 	switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          	  case 0:
/*< 69>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F08\xD09Je vois que tu es un passionné!\nTu n'as pas investi pour rien,\ntu vas voir!")
          	  case 1:
/*< 61>*/ 		OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 1), ('next', 62), ('param3', 12)])
/*< 62>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F00\xD09Les fouilles, ça t'intéresse?\x0E\x01\x04\x02<\nJ'ai une proposition à te faire...\x0E\x01\x04\x02<\nTu vas sauter sur l'occasion!\n\n\x0E\x01\x09\x04\x2F00\xD07Les recherches, ça demande de\nl'argent.\x0E\x01\x04\x02\x1E Ça te dirait pas d'investir\ndans les miennes? 10 rubis seulement!\n\n[1]D'accord[2-]Non merci")
/*< 59>*/ 		switch (choice(2)) {
          		  case 0:
/*< 63>*/ 			switch (has_rupees(10)) {
          			  case 0:
/*< 64>*/ 				rupees += -10;
/*< 66>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F02\x208Merci! Tu verras, tu ne le regretteras\npas, c'est certain!")
/*< 67>*/ 				story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */] = true;
          				flw_98:
/*< 98>*/ 				scene_flags[9 'Lanayru Gorge'][106 /* 0xC 04 */] = true;
          			  case 1:
/*< 65>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Oh, t'as pas d'argent?\nReviens me voir quand tu seras prêt\nà investir!")
          				goto flw_98
          			}
          		  case 1:
/*< 60>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x2F01\x805\x0E\x01\x06\x02\xFFCDOh, dommage.\x0E\x01\x04\x02\x1E\nJ'ai bien l'impression que les fouilles,\nça n'intéresse plus personne...")
          			goto flw_98
          		}
          	}
          }
...
/*< 77>*/ 	start()
/*< 78>*/ 	printf(/* textboxtype: 8, unk: 0 */ "Vers les mines de Lanelle,\npour percer le mystère\ndes chronolithes...")
          }
...
/*< 92>*/ 	start()
/*< 93>*/ 	printf(/* textboxtype: 7, unk: 0 */ "Entrée strictement interdite\nsans autorisation de <b<Lanelle>>, le\n<b<dragon de foudre>>.")
          }
