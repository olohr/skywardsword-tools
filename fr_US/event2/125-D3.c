...
/*< 40>*/ 		printf(/* textboxtype: 2, unk: 0 */ "Je vous recommande d'avancer avec\ndétermination.")
          	  case 1:
/*< 35>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nJe détecte la présence d'une force\nsacrée dans cette salle.")
          		goto flw_39
          	}
          }
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez\nprendre connaissance de ces\ninformations pertinentes :\n\nVous êtes arrivé jusqu'à l'emblème.\nPlantez\x2010y votre épée. Vous devriez\nalors être conduit vers la <y+<Triforce>>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez\nprendre connaissance de ces\ninformations pertinentes :\n\nVous êtes arrivé jusqu'à l'emblème.\nPlantez\x2010y votre épée. Vous devriez\nalors être conduit vers la <y+<Triforce>>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez\nprendre connaissance de ces\ninformations pertinentes :\n\nVous êtes arrivé jusqu'à l'emblème.\nPlantez\x2010y votre épée. Vous devriez\nalors être conduit vers la <y+<Triforce>>.")
          }
...
/*<  6>*/ 			story_flags[685 /* us: 805A9B21 0x04, jp: 805ACDA1 0x04 */] = true;
          		  case 1:
/*< 56>*/ 			printf(/* textboxtype: 2, unk: 2 */ "En exploitant ces changements, vous\ndevriez pouvoir vous rendre dans les\nautres salles.")
          			goto flw_5
          		}
          	}
          }
