...
/*<289>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*<290>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01La statue de la Déesse a bel et bien\ndisparu, mais la Déesse, elle, restera\ntoujours en chacun d'entre nous!\n\nTu ne crois pas, Link?")
          	  case 1:
/*<282>*/ 		switch (story_flags[642 /* us: 805A9B1D 0x08, jp: 805ACD9D 0x08 */]) {
          		  case 0:
/*<283>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Tu as l'air d'avoir pris beaucoup de\nmaturité. Continue comme ça!")
          		  case 1:
/*<278>*/ 			switch (story_flags[328 /* us: 805A9AFF 0x40, jp: 805ACD7F 0x40 */]) {
          			  case 0:
/*<281>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Pardon? Le grand Narisha?\x0E\x01\x04\x02(\nOui, j'en ai entendu parler, mais...\n\n\nJe ne sais pas grand\x2010chose à son sujet,\ndésolé.\n\n\nPour ce genre de chose, il faut\nt'adresser à <b<maître Arfan>>, ton\nprofesseur de travaux pratiques!")
          			  case 1:
...
/*<225>*/ 	switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Et puis, Link? Tout se\npasse bien pour toi?\n\n\nSi tu as un problème, n'hésite pas à\nm'en parler!")
          	  case 1:
...
/*<220>*/ 			switch (story_flags[328 /* us: 805A9AFF 0x40, jp: 805ACD7F 0x40 */]) {
          			  case 0:
/*<223>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x05Qu'est-ce que tu fais dehors à cette\nheure si tardive, Link?\n\n\nQu'est-ce que tu racontes? Le grand\nNarisha? Ce n'est pas le moment d'en\nparler, il se fait bien tard...\n\nReviens plutôt demain, et je te\nraconterai ce que je sais.")
          			  case 1:
...
/*<122>*/ 			switch (story_flags[643 /* us: 805A9B1D 0x10, jp: 805ACD9D 0x10 */]) {
          			  case 0:
/*<102>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Qu'est-ce qui se passe? Plonge donc!\nOu bien souhaites\x2010tu t'arrêter là?\n[1]Je continue[2-]J'arrête")
/*<117>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<146>*/ 	start()
/*<149>*/ 	printf(/* textboxtype: 1, unk: 0 */ "C'est ça. Vas-y maintenant.")
          }
...
/*<155>*/ 				set_camera(20, 0)
/*< 52>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Rends\x2010toi à la <r<statue de la déesse\n>>et dis au directeur que nous l'avons\nretrouvée.")
/*<241>*/ 				set_camera(21, 0)
...
/*< 46>*/ 			switch (temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*< 47>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x06Qu'est-ce qu'il y a, Link?")
/*< 61>*/ 				set_camera(14, 0)
