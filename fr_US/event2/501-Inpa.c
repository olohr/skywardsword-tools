...
/*<456>*/ 				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 72)])) {
          				  case 0:
/*<455>*/ 					printf(/* textboxtype: 1, unk: 0 */ "Y a vraiment rien ici, c'est déprimant.\nQuand je pense que Mémé vit ici\ndepuis des lustres...\n\nElle a jamais pensé à planter un arbre\ndans le coin?")
          				  case 1:
/*<458>*/ 					printf(/* textboxtype: 1, unk: 0 */ "Quand je regarde Mémé, je me dis que\nje ne serais pas capable de la laisser\ntoute seule...\n\n\x0E\x01\x09\x04\x00\xA00Surtout, va pas raconter à mes gars\nque je m'occupe d'une vieille, hein!")
          				}
          			}
          		}
          	  case 1:
...
/*< 63>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Tu as ma gratitude, Link.")
/*< 65>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 14), ('param2', 4), ('next', 62), ('param3', 17)])
/*< 62>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Et toi aussi, <b<Hergo>>.")
...
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Je n'ose pas imaginer ce qui aurait pu\nse produire si vous n'aviez pas été là,\ntous les deux...")
/*< 69>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 4), ('param2', 14), ('next', 70), ('param3', 50)])
/*< 70>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\x0DHéhé! Arrête Mémé, tu vas me faire\nrougir!\n\n\nEt puis, c'est toi qui m'as montré quoi\nfaire quand je pleurnichais comme\nun bon à rien.")
...
/*< 77>*/ 	printf(/* textboxtype: 1, unk: 0 */ "... C'est bien ça, Mémé?")
...
/*< 78>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\xE01\x07... En effet. Va vers la porte.\nVa, Link!")
/*<306>*/ 	set_camera(53, 0)
...
/*< 56>*/ 	printf(/* textboxtype: 1, unk: 2 */ "\x0E\x01\x09\x04\x400=Hein? Tu veux rire, Mémé!")
/*< 58>*/ 	set_camera(18, 0)
          	flw_27:
/*< 27>*/ 	OrderedDict([('type', 'type3'), ('subType', 0), ('param1', 0), ('param2', 30), ('next', 12), ('param3', 6)])
/*< 12>*/ 	set_camera(10, 0)
/*< 13>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\x02Tu veux vraiment rire de moi?\nRépète donc, pour voir!")
...
/*< 17>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400>\x0E\x01\x08\x02\x1CDLa ferme, Mémé!\n\n\n\nMoi, le grand <b<Hergo>>, je pourrais pas\nsauver <b<Zelda>>? C'est mal me connaître,\nMémé!\n\nSi je peux pas la sauver, alors pourquoi\nje serais venu jusqu'ici, hein? Pfff!\nEt puis, qui d'autre que moi pourrait\nla sauver? Je te le demande!")
...
/*< 21>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\x3218Ah... Je vois.\n\n\n\n\x0E\x01\x09\x04\x40D\xA00\x0E\x03\x01\x00Link, Mémé essaie de me\ndire que c'est toi le grand héros qui va\nsauver <b<Zelda>>... Hmf.")
...
/*< 25>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400<Quelle farce! Je m'en fiche que ce\nsoit ta destinée ou je sais pas quoi!\nJ'accepterai jamais ça!\n\n\x0E\x01\x09\x04\x40B\xA00Je te connais, et tu n'as rien d'un héros,\npetit pois!")
...
/*< 42>*/ 	set_camera(16, 0)
/*< 43>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\xE0E\xFF05... Je vois. Elle était là, elle aussi.\n\n\n\nCette femme que tu as vue aux\ncôtés de Zelda se nomme <b<Impa>>...\nElle a été envoyée par la <b<Déesse\n>>pour servir Zelda.")
...
/*<131>*/ 	set_camera(48, 0)
/*< 91>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x403\xFF00\x0E\x03\x01\x00Link! J'aurais quelque\nchose à te demander...")
...
/*< 92>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x403\xFF02Dis\x2010moi... <b<Zelda>>... Elle va bien?\n[1]Oui[2]En fait...")
/*< 95>*/ 	switch (choice(2)) {
          	  case 0:
/*< 93>*/ 		printf(/* textboxtype: 1, unk: 0 */ "C'est vrai? Tant mieux.\n\n\n\n\x0E\x01\x09\x04\x403\x200Mais... c'est pas encore fini, hein?")
          		flw_97:
/*< 97>*/ 		set_camera(35, 0)
/*< 96>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x40E\xD09Tu sais, Link, j'ai décidé\nde ne pas retourner à Célesbourg.\n\n\n\x0E\x01\x09\x04\x400\x200Je vais vivre ici avec Mémé.")
/*< 98>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\xFF0DHéhé... Prends pas ça personnellement.\nJe suis très content de ma décision.\n\n\n\x0E\x01\x09\x04\x400\x200Je ne sais pas comment t'expliquer...\nJe sens que j'ai encore quelque chose\nà accomplir ici.\n\nIl faut surveiller le gros monstre, \x0E\x01\x09\x04\x400\x211et\npuis il faut s'occuper de Mémé...\n\n\nC'est peut\x2010être pas aussi grandiose\nque ta mission, mais c'est peut\x2010être\nma destinée, à moi! Je pense que tu\npeux comprendre ce que je veux dire.")
/*<100>*/ 		set_camera(36, 0)
/*< 99>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x403\xD08Et puis, j'aime ça ici. C'était bien de\nvivre dans le ciel, mais j'aime bien\navoir les deux pieds sur terre!")
...
/*<109>*/ 		set_camera(37, 0)
/*<107>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x404\x208Grâce à Zelda et Mémé, la vie reprend\nsur cette terre.\n\n\n<r<Si on plantait une pousse >>ici, je suis\nsûr qu'elle deviendrait un grand arbre\nbien solide au fil des ans. Ça mettrait\nencore plus de vie!\n\x0E\x01\x09\x04\x40D\x211Enfin, ça prend des années pour qu'un\narbre soit bien grand. Mais faut savoir\nêtre patient, des fois.\n\n\x0E\x01\x09\x04\x400\x12C'est comme ça que je vois les choses\nen ce moment.")
/*<110>*/ 		set_camera(36, 0)
/*<320>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 4), ('param2', 100), ('next', 106), ('param3', 17)])
/*<106>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x40D\x22EEt puis... Euh... Bien...\nSi tu retournes à Célesbourg, dis\nbonjour à tout le monde de ma part.\n\n\x0E\x01\x09\x04\x400\xE00Dis\x2010leur que je vais bien et que\nj'aime mon nouveau chez\x2010moi.\nMes compères, Orbo et Latruche,\ns'en remettront sûrement pas!\n\x0E\x01\x09\x04\x400\x209Merci, Link!")
...
/*<111>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', -1), ('param3', 42)])
          	  case 1:
/*< 94>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\x1400Ouf... C'est pas drôle, ce qui lui\narrive...\n\n\n\x0E\x01\x09\x04\x403\x200Mais, tu vas arranger tout ça, hein?")
          		goto flw_97
          	}
          }
...
/*<335>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01\x0E\x01\x06\x02\xFECDOoh... L'enfant du destin...~~~\nBienvenue à toi, jeune élu descendu\ndes cieux par\x2010delà la mer de nuages.")
...
/*< 10>*/ 	printf(/* textboxtype: 1, unk: 2 */ "\x0E\x01\x09\x04\x400=Hein? Tu veux rire, Mémé!")
/*<392>*/ 	set_camera(17, 0)
...
/*<116>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x400\x0DHéhé! Y'a rien là! Je m'en occupe!\n\n\n\nPendant qu'on combattait, j'ai pensé à\nune nouvelle manière d'utiliser ma\n<r<mégatapulte>>!\n\nSi tu montes dedans et que je tire à\npleine puissance, t'arriveras dans\nla forêt en un clin d'\x153il!")
/*<127>*/ 	set_camera(26, 0)
/*<125>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x40C\x202Je sors préparer ma machine!\nSuis\x2010moi, Link!")
...
/*<263>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x00Rattrape ce monstre,\nLink!\nFaut que tu sauves <b<Zelda>>!")
          }
