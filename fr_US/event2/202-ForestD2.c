...
/*< 15>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Quelle obstination.~~.~~.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0 */ "J'ai besoin de temps pour trouver\nle moyen de rappeler mon maître\nà la vie.~~.~~.")
/*< 20>*/ 	set_camera(4, 0)
