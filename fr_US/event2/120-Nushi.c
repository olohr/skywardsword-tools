...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Bon, je dépose la soupe de citrouille\njuste ici.\n\n\nDrôle d'endroit pour livrer de la soupe.\nEt pas très rassurant non plus. On \ndirait qu'on pourrait se faire attaquer\nà tout moment.")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Ça y est, j'ai fait ma part.\nJe me sauve!\x0E\x01\x05\x04(\x00")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Hoho! C'est extraordinaire.\nTu as trouvé la Triforce!")
          		flw_35:
...
/*< 37>*/ 							story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
          						  case 1:
/*<  3>*/ 							printf(/* textboxtype: 1, unk: 0 */ "Si je connais? Tu sais que tu t'adresses\nau grand esprit qui veille sur...\n\x0E\x01\x04\x02\x14Mais passons.")
          							goto flw_4
          						}
          					}
          				}
