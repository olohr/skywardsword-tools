								  ...
								  case 0:
									switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 7), ('param3', 9), ('param4', 2), ('param5', 18)])) {
									  case 0:
										...
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 24), ('next', 44), ('param3', 29)])
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 24), ('next', 45), ('param3', 29)])
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 7), ('param2', 24), ('next', 32), ('param3', 29)])
										flw_32:
									  ...
									  case 1:
										...
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 7), ('param2', 24), ('next', 32), ('param3', 28)])
										goto flw_32
									}
								  case 1:
									printf("I suggest using smart tactics to your\nadvantage. Try #####leaving easy-to-collect\ntears #####for when you are being pursued.")
									OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 24), ('next', 32), ('param3', 28)])
									goto flw_32
								}
							  case 1:
								...
								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 24), ('next', 32), ('param3', 28)])
								goto flw_32
							}
						  case 1:
							...
							OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 4), ('param2', 24), ('next', 32), ('param3', 28)])
							goto flw_32
						}
					  case 1:
						...
						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 24), ('next', 32), ('param3', 28)])
						goto flw_32
					}
				  case 1:
					...
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 2), ('param2', 24), ('next', 49), ('param3', 28)])
					goto flw_49
				}
			  case 1:
				printf("######Master ####.")
				...
				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 24), ('next', 49), ('param3', 28)])
				goto flw_49
			}
		  case 1:
			printf("######Master ####.")
			  ...
			  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 2), ('param4', 4), ('param5', 20)])) {
				  case 0:
					...
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 2), ('param2', 0), ('next', 53), ('param3', 39)])
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 0), ('next', 55), ('param3', 40)])
					printf("######Master, do you see the glowing\nobject just in front of you?")
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 59), ('param3', 39)])
					printf("That is a #########-#####.\nYou will need to collect #####15 #####of them.")
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 31), ('param2', 1), ('next', 57), ('param3', 40)])
				  ...
				  case 1:
					...
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 0), ('next', 64), ('param3', 39)])
					...
					printf("If a #####Guardian #####manages to land even\none attack on you, your spirit will\nshatter and you will fail the trial.")
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 0), ('next', 66), ('param3', 39)])
