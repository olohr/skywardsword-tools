...
/*<113>*/ 	start()
/*<120>*/ 	switch (loadzone_temp_flags[4 /* 0x9 10 */]) {
          	  case 0:
/*<112>*/ 		printf("___________Good one!")
/*<124>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 125), ('param3', 39)])
/*<125>*/ 		printf("______That sure looked like it felt good!\n\n\n\n______So... Why don't you try a <g<fatal blow\n>>to close out our session?\n[1]Sure![2-]Nah.")
          	  case 1:
/*<121>*/ 		printf("______What's the matter, Link?\nYou don't seem your usual self.")
/*<122>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 123), ('param3', 39)])
/*<123>*/ 		printf("______Stand in the center of a pack of\nenemies, and swing the Wii Remote and\nNunchuk <r<horizontally at the same time>>.\nThat's how you do a real spin attack.\n______Do you want to try again?\n[1]Please![2-]Nah...")
          	}
          }

          void entrypoint_119_11() {
/*<115>*/ 	start()
/*<111>*/ 	printf("______Great! Now I'm going to surround you\nwith logs. You need to cut them all\nwithout moving from that spot!\n\nAll you have to do is swing the\nWii Remote and Nunchuk <g<horizontally\n>><r<at the same time>>.\n\n______Give it a shot!")
          }

          void entrypoint_119_12() {
/*<126>*/ 	start()
/*<127>*/ 	printf("______All right! When your enemy is down,\n<r<target >>it with (Z) and <r<swing the\nWii Remote and Nunchuk at the same\ntime >>to land a <g<fatal blow>>._____\n______Do a side slash on that log. When it's\ndown, try finishing it off with this\ntechnique!")
          }

          void entrypoint_119_13() {
/*<128>*/ 	start()
/*<129>*/ 	printf("___________That's the way!")
/*<130>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 131), ('param3', 39)])
/*<131>*/ 	printf("______A <g<fatal blow>> is also an effective\nmove to use right after you've used\nyour <r<shield >>or a well-placed <g<spin attack\n>>to knock an enemy on its back.\n______Oh, but monsters don't stay down for\nlong, so you'll have to swing the\nWii Remote and Nunchuk quickly\nbefore they get back on their feet!")
          }

          void entrypoint_119_01() {
          	start()
/*< 68>*/ 	switch (loadzone_temp_flags[1 /* 0x9 02 */]) {
          	  case 0:
/*< 70>*/ 		printf("______Send my regards to the owner of\nthe Lumpy Pumpkin!")
          	  case 1:
/*< 53>*/ 		switch (story_flags[292 /* us: 805A9AFA 0x40, jp: 805ACD7A 0x40 */]) {
          		  case 0:
/*< 54>*/ 			switch (adventure_pouch_has(2 0x0002)) {
          			  case 0:
/*< 67>*/ 				switch (loadzone_temp_flags[2 /* 0x9 04 */]) {
          				  case 0:
          					flw_57:
/*< 57>*/ 					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 119), ('param2', 3), ('next', -1), ('param3', 7)])
          				  case 1:
/*< 58>*/ 					printf("______Hey...did you happen to bring more\npiping-hot pumpkin soup?! It looks\nsooo good...\n[1]Uh...here.[2]...")
/*< 59>*/ 					switch (choice(2, 0)) {
          					  case 0:
/*< 61>*/ 						printf("______Oh! For me?! I mean, sorry for just\nassuming it was for me...\n\n\nWell, in that case, I'll help myself!")
...
/*< 99>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 10), ('param2', 0), ('next', 100), ('param3', 39)])
...
/*<103>*/ 						printf("Sooo good!______")
/*<104>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 11), ('param2', 0), ('next', 63), ('param3', 39)])
/*< 63>*/ 						printf("______Yeah! That hits the spot!\n\n\n\n______I tell you, morning, noon, or night,\nnothing satisfies like Pumm's yummy \npumpkin soup!")
/*<154>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 10), ('next', 144), ('param3', 47)])
/*<144>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 12), ('param2', 0), ('next', 143), ('param3', 39)])
...
/*<142>*/ 						printf("______Thank you, Link! \nHere's a token of my appreciation.")
/*<105>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', 64), ('param3', 42)])
/*< 64>*/ 						give_item(4 0x04);
/*< 71>*/ 						loadzone_temp_flags[1 /* 0x9 02 */] = true;
          					  case 1:
/*< 60>*/ 						printf("_____...\n..._____\n\n\n______HAH! Just joking around with you!")
/*< 65>*/ 						loadzone_temp_flags[2 /* 0x9 04 */] = true;
          					}
          				}
          			  case 1:
          				goto flw_57
...
/*< 95>*/ 							OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 10), ('param2', 0), ('next', 91), ('param3', 39)])
...
/*< 94>*/ 							printf("Sooo good!______")
/*< 96>*/ 							OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 11), ('param2', 0), ('next', 52), ('param3', 39)])
/*< 52>*/ 							printf("______Mmm! This is the stuff!\n\n\n\n______Pumpkin soup is best piping hot!")
...
/*< 97>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 10), ('param2', 0), ('next', 88), ('param3', 39)])
...
/*<147>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 11), ('param2', 0), ('next', 146), ('param3', 39)])
/*<146>*/ 								printf("Ugh! This is disgusting..._____ It's cold!")
...
/*< 98>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 12), ('param2', 0), ('next', 150), ('param3', 39)])
/*<150>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 10), ('next', 50), ('param3', 48)])
/*< 50>*/ 								printf("If there are two things I can't stand in\nthis world, it's cold soup and slackers.\nNow bring me another one--and make\nit hot!")
/*<137>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', -1), ('param3', 42)])
          							  case 1:
/*< 46>*/ 								printf("______What?! Weren't you asked to bring\nthis to me? You think you can tease\nme like this? You DO NOT tease a man\nabout pumpkin soup!\n______If this soup isn't good anymore, you're\ngoing to have to go get me some more!\n\n\nAnd it had better be hot!")
          							}
          						  case 1:
/*< 38>*/ 							printf("______Huh... I told Pumm to bring some\nright away, so what is he doing?\n______You do not want to be around me when\nI don't get my daily pumpkin soup.")
          						}
          					  case 1:
/*< 56>*/ 						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 119), ('param2', 3), ('next', -1), ('param3', 7)])
          					}
          				}
          			  case 1:
/*< 69>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 119), ('param2', 3), ('next', -1), ('param3', 7)])
          			}
          		}
          	}
          }
...
/*< 25>*/ 	printf("______Hey! _________Link!")
/*< 31>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 11), ('param2', 0), ('next', 72), ('param3', 16)])
/*< 72>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 0), ('next', 28), ('param3', 39)])
/*< 28>*/ 	printf("______You can't take swords outside of the\nSparring Hall.\n\n\nWhat do you think you're doing\nsneaking out with that?!")
/*< 73>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 2), ('param2', 0), ('next', 29), ('param3', 39)])
...
/*<161>*/ 	switch (adventure_pouch_has(0 0x0000)) {
          	  case 0:
/*< 79>*/ 		printf("______That log is used to practice defense.\n\n\n\n______Hit the log with your sword, and then\n<g<sharply move the Nunchuk forward >>to\nexecute a <r<shield bash >>when it swings\nback at you.")
          	  case 1:
/*< 77>*/ 		switch (adventure_pouch_has(9 0x0009)) {
          		  case 0:
/*<162>*/ 			printf("______That log is used to practice <r<defense>>.\nYou don't have a <r<shield>> equipped,\nthough, so don't mess with it, or it'll\nsend you flying!")
          		  case 1:
/*< 78>*/ 			printf("______That log there is for practicing\n<r<defense>>. You don't have a <r<shield>> yet, so\ndon't mess with it, or it'll send you\nflying!")
          		}
          	}
          }
...
/*<109>*/ 	start()
/*<114>*/ 	printf("____\n_That's right, Link!")
/*<116>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 110), ('param3', 39)])
/*<110>*/ 	printf("______You really are a strong swordsman. \nEasy to teach too. You make this\ninstructor proud!\n\n______Are you ready to try a <g<spin attack>>?\n[1]OK![2-]Not yet.")
          }
