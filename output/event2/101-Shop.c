...
/*<110>*/ 				printf("______Ahaa! My friend, I just got a <r<new item\n>>in today!\n\n\nMy latest treasure is a finely crafted\n<y<_____>>! For discerning\nbow owners, it's simply a must.\n\nTake a look for yourself!")
/*<111>*/ 				loadzone_temp_flags[1 /* 0x9 02 */] = true;
...
/*<107>*/ 					printf("______Ahaa! I've got something <r<new>> in stock\nfor you, friend.\n\n\nIt's a very mysterious shield called a\n<y<____z>>. I suggest you\nlinger and give it a good look.")
/*<108>*/ 					loadzone_temp_flags[1 /* 0x9 02 */] = true;
...
/*<104>*/ 						printf("______Oh, yes, my friend! I've got something\n<r<new>> to show you!\n\n\nToday, I was able to procure a fine\n<y<_____>>! I do hope that it\ndelights you.")
/*<105>*/ 						loadzone_temp_flags[1 /* 0x9 02 */] = true;
...
/*<141>*/ 	loadzone_temp_flags[5 /* 0x9 20 */] = true;
...
/*<  7>*/ 	start()
/*<  8>*/ 	switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 11), ('param4', 2), ('param5', 2)])) {
          	  case 0:
/*<  9>*/ 		printf("")
          	  case 1:
/*< 10>*/ 		printf("")
...
/*<142>*/ 	loadzone_temp_flags[5 /* 0x9 20 */] = true;
...
/*<128>*/ 		loadzone_temp_flags[5 /* 0x9 20 */] = false;
          	  case 1:
          	}
          }
...
/*<143>*/ 	loadzone_temp_flags[5 /* 0x9 20 */] = true;
...
/*<132>*/ 				switch (story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */]) {
          				  case 0:
          					flw_70:
/*< 70>*/ 					printf("I've taken the liberty of placing your\npurchases in your pouch. Press <g<_____\n>>to open it, then<r< equip >>what you need!_____")
          					flw_137:
/*<137>*/ 					loadzone_temp_flags[5 /* 0x9 20 */] = false;
          				  case 1:
...
/*<131>*/ 	loadzone_temp_flags[5 /* 0x9 20 */] = false;
          }
