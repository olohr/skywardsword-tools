...
/*< 62>*/ 	switch (story_flags[362 /* us: 805A9B03 0x01, jp: 805ACD83 0x01 */]) {
          	  case 0:
/*< 63>*/ 		printf("However, in order to aid Levias,\nyou will need to learn the <g<Spiral\nCharge >>flight maneuver from\n<b<Instructor Owlan>>.______")
          	  case 1:
/*< 64>*/ 		printf("<b<Instructor Owlan >>knows a great deal\nabout Levias. I recommend that you\nask him for more information about\nthis great spirit.______")
          	}
          }
...
/*< 66>*/ 	switch (story_flags[157 /* us: 805A9AE0 0x08, jp: 805ACD60 0x08 */]) {
          	  case 0:
/*< 67>*/ 		printf("Using the <y<Clawshots>>, you have managed\nto enter the <b<Lanayru Sand Sea>>.\nI suggest you search the area for\nclues leading to the next sacred flame.______")
          	  case 1:
/*< 68>*/ 		printf("There is a 96% chance that you can \nreach new locations within <b<Lanayru\nProvince>> using the <y<Clawshots>> you got\nfrom the <r<trial >>in the <b<Lanayru Desert>>.______")
          	}
          }
...
/*< 69>*/ 	start()
/*< 70>*/ 	printf("Current Session Play Time: <r<_______________>>\nTotal Play Time: <r<<r<_______<r<________>>\nThis concludes my analysis.")
          }
...
/*< 78>*/ 	switch (story_flags[269 /* us: 805A9AF9 0x80, jp: 805ACD79 0x80 */]) {
          	  case 0:
/*< 80>*/ 		printf("I advise you to take the sea chart\nyou've obtained back to the robot\ncaptain.______")
          	  case 1:
/*< 79>*/ 		printf("To take back the ship, you will first\nneed to travel to <b<Skipper's Retreat>>\nand obtain a sea chart.______")
          	}
          }
...
/*< 23>*/ 	switch (story_flags[130 /* us: 805A9AE4 0x01, jp: 805ACD64 0x01 */]) {
          	  case 0:
/*< 24>*/ 		printf("I recommend you follow the advice of\nthe old woman at the <b<Sealed Temple \n>>and head to <b<Faron Woods>>.______")
          	  case 1:
/*< 25>*/ 		printf("I've detected remnants of civilization\nhere on the surface. I advise you to\nfirst explore the area near where you\ntouched down.______")
          	}
          }
...
/*< 48>*/ 	switch (story_flags[187 /* us: 805A9AE9 0x04, jp: 805ACD69 0x04 */]) {
          	  case 0:
/*< 49>*/ 		printf("I've confirmed a very large structure\npositioned atop the volcano's summit.\nI recommend you explore it.______")
          	  case 1:
/*< 50>*/ 		printf("To extinguish the wall of fire blocking\nyour path beyond the summit, you need\nto transport the giant <r<water basin >>used\nby the Water Dragon.______")
          	}
          }
...
/*< 52>*/ 	switch (story_flags[344 /* us: 805A9AFE 0x40, jp: 805ACD7E 0x40 */]) {
          	  case 0:
/*< 53>*/ 		printf("______Master, you have now passed through\nthe <r<Gate of Time>>.\n\n\nProceed forward. I calculate a 99%\nprobability that <b<Zelda >>waits just ahead.______")
          	  case 1:
/*< 54>*/ 		printf("The time has finally come to awaken\nthe <r<Gate of Time >>using the power of\nyour enhanced sword. I suggest you\nmake this your immediate priority.______")
          	}
          }
...
/*< 74>*/ 	switch (story_flags[120 /* us: 805A9AEA 0x20, jp: 805ACD6A 0x20 */]) {
          	  case 0:
/*< 76>*/ 		printf("You have reassembled the key to the\ntemple on Eldin Volcano, and you are\nheaded there to open its door.______")
          	  case 1:
/*< 75>*/ 		printf("You are currently looking for the <r<key\nto open the temple door>>. This key\nhas been split into five pieces which can\nbe located with your <g<dowsing>> ability.______")
          	}
          }
