...
/*<108>*/ 	start()
          ...
          void entrypoint_109_01() {
          	start()
/*< 25>*/ 	switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 0), ('param3', 15), ('param4', 3), ('param5', 13)])) {
          	  case 0:
/*< 20>*/ 		switch (story_flags[150 /* us: 805A9AE1 0x10, jp: 805ACD61 0x10 */]) {
          		  case 0:
/*<126>*/ 			switch (loadzone_temp_flags[2 /* 0x9 04 */]) {
          			  case 0:
          				flw_109:
/*<109>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 109), ('param2', 3), ('next', -1), ('param3', 7)])
          			  case 1:
...
/*< 89>*/ 									switch (story_flags[639 /* us: 805A9B1D 0x02, jp: 805ACD9D 0x02 */]) {
          									  case 0:
/*<119>*/ 										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 109), ('param2', 3), ('next', -1), ('param3', 7)])
          									  case 1:
...
/*< 90>*/ 									switch (story_flags[639 /* us: 805A9B1D 0x02, jp: 805ACD9D 0x02 */]) {
          									  case 0:
/*<118>*/ 										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 109), ('param2', 3), ('next', -1), ('param3', 7)])
          									  case 1:
...
/*< 92>*/ 										printf("______Hey, Link! Have I got\nnews for you!\n\n\nMy sweetie daughter's given her\ngood-for-nothin' feller the boot!\n\n\n______Of course, I feel for her. I hate to see\nher blue and all, but...\n\n\n______I'm pleased as punch the egg-swipin'\nscamp's out of the picture!\n\n\nTell me true, Link. Are\nyou responsible for breakin' them up?\nNever mind! It makes no difference\nto me.\n______I'm as happy as a Loftwing in an\nupdraft. I truly am.")
...
/*<149>*/ 										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', -1), ('next', -1), ('param3', 42)])
          							  ...
          							  case 1:
/*<110>*/ 								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 109), ('param2', 3), ('next', -1), ('param3', 7)])
          							}
          						  case 1:
...
/*< 97>*/ 							printf("______Howdy, Link! I was\nhoping I'd run into you.\n\n\n[1]Why?[2]Daughter?")
/*< 98>*/ 							switch (choice(2, 0)) {
          							  case 0:
/*< 99>*/ 								printf("______What do you mean \"why\"? This is\nimportant! My little girl's in trouble!")
          								flw_101:
/*<101>*/ 								printf("______Yep, the shinin' star of the Item Check\nis the source of my problem. That's my\ndarlin' daughter, in case you forgot.\n\nShe's been out of sorts lately. She'll\nbe sittin' and starin' off into yonder,\nand then she'll get redder than a\ntomato on the vine.\n______Wait just a gosh-darn minute!\nI know what's going on! My sunshine's\ngot herself an______ <r<unwanted admirer>>!\n\nNot that I can blame the feller. She's as\nsweet as honey and twice as pretty as a\nspring flower! ______Nope--three times as\npretty!\nIt's no wonder the boys buzz around\nher like a swarm of amorous bees.")
...
/*< 15>*/ 					give_item(64 0x40);
          	  ...
          	  case 2:
/*< 12>*/ 		printf("______What seems to be the problem?\nTime's up!")
          	}
          }
