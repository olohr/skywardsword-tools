	  ...
	  case 0:
		...
		switch (story_flags[786 /* us: 805A9B2C 0x04, jp: 805ACDAC 0x04 */]) {
		  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 86)])) {
			  case 0:
	  ...
	  case 0:
		...
		switch (story_flags[786 /* us: 805A9B2C 0x04, jp: 805ACDAC 0x04 */]) {
		  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 92)])) {
			  case 0:
	  ...
	  case 0:
		...
		switch (story_flags[786 /* us: 805A9B2C 0x04, jp: 805ACDAC 0x04 */]) {
		  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 98)])) {
			  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 100)])) {
				  case 0:
		  ...
		  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 110)])) {
			  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 112)])) {
				  case 0:
...
void entrypoint_006_655() {
	...
	switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 122)])) {
	  case 0:
			  ...
			  case 0:
				switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
				  case 0:
					...
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 50)])) {
					  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 22), ('param4', 4), ('param5', 54)])) {
			  case 0:
				switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
				  ...
				  case 1:
					printf("Speech analysis indicates absolute\nconfidence in his own abilities.\n\n\n######Master, you must watch for Ghirahim's\nability to grasp your sword with his\nbare #####right hand#####.\n\nIt is highly probable that he observes\nthe #####angle you hold your sword at##### and\nprepares his defense accordingly.\n\nI recommend attacking from the\ndirection opposite his hand.\n#####More info!#####I'm ready.")
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 248)])) {
					  case 0:
						printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ######Master, your sword will flash.\nYou can always press ##### to call on me.#####\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n#####Analysis#####.")
					  case 1:
					}
			  ...
			  case 0:
				switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
				  case 0:
					...
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 230)])) {
					  case 0:
						...
						switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 232)])) {
						  case 0:
		  ...
		  case 0:
			...
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 104)])) {
			  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 106)])) {
				  case 0:
					...
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 250)])) {
					  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 252)])) {
				  case 0:
					...
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 254)])) {
					  case 0:
						printf("I have noted that Ghirahim has a\ntendency to stand near the center of\nthe platform, ######Master.\n\nThere is an 85% probability he does\nthis to avoid falling off.\n#####More info!#####Got it.")
						switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 256)])) {
						  case 0:
							printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ######Master, your sword will flash.\nYou can always press ##### to call on me.#####\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n#####Analysis#####.")
						  case 1:
						}
...
void entrypoint_006_651() {
	...
	switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 102)])) {
	  case 0:
		goto flw_238
	  case 1:
	}
...
void entrypoint_006_669() {
	...
	switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 164)])) {
	  case 0:
		printf("It is clear that #####Skyward Strikes #####cannot\nbe called down to your sword because\nthis place is under the magical\ninfluence of Demise.\nAttacks using #####Skyward Strike energy\n#####will not be possible here.\n#####Tell me more.#####Got it.")
		switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 0), ('param4', 2), ('param5', 174)])) {
		  case 0:
			printf("It is highly probable that the only\nweapon capable of wounding Demise\nis the #####Master Sword #####itself. No other\nweapon can affect it.\n#####Tell me more!#####Got it.")
