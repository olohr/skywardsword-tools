...
/*<256>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_89
          			  case 1:
/*< 92>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
          	}
...
/*<257>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_98
          			  case 1:
/*<101>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
          	}
...
/*<258>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_107
          			  case 1:
/*<110>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
          	}
...
/*<254>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_125
          			  case 1:
/*<128>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
          	}
...
/*<255>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_137
          			  case 1:
/*<136>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
          	}
...
/*<161>*/ 	start()
/*<163>*/ 	printf("This eternal being has conquered time\nitself. It is the source of all monsters.\n\n\nAccording to tales passed down through\ngenerations, it appears differently in\neach epoch and to each person who\nlays eyes on it.[1]Tell me more![2-]Understood.")
/*<162>*/ 	switch (choice(2, 0)) {
          	  case 0:
/*<236>*/ 		printf("It is clear that <r<Skyward Strikes >>cannot\nbe called down to your sword because\nthis place is under the magical\ninfluence of Demise.\nAttacks using <r<Skyward Strike energy\n>>will not be possible here.\n[1]Tell me more.[2-]Got it.")
...
/*<247>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_34
          			  case 1:
/*< 37>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          			}
          		}
          	  case 1:
/*<173>*/ 		printf("Whatever you think is best, ______Master.\nPlease call for me if you want to hear\nmy findings at a later time.")
          	}
          }

          void entrypoint_006_659() {
/*<174>*/ 	start()
/*<175>*/ 	printf("I have something to report, ______Master.\nMy analysis of this enemy's movement\npatterns is complete.\n\nWhile holding (Z) to lock on to the\nenemy, press (v) to call me. I will\ngive you my analysis.__________ Would you like to\nhear it now?[1]Yes.[2-]No.")
/*<176>*/ 	story_flags[774 /* us: 805A9B2A 0x40, jp: 805ACDAA 0x40 */] = true;
/*<177>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		flw_17:
...
/*< 18>*/ 				printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          	  ...
          	  case 1:
/*<178>*/ 		printf("Whatever you think is best, ______Master.\nPlease call for me if you want to hear\nmy findings at a later time.")
          	}
          }

          void entrypoint_006_677() {
/*< 42>*/ 	start()
/*< 44>*/ 	printf("As you can likely gather from its other\ntitle, this _Abyssal Leviathan\" is said to\nhave been a tyrant of the ancient seas.\n\nIts <y<<r<enormous tentacles<y< >>can be repelled,\nbut they will regenerate after a\nshort time.\n[1]More info![2-]Understood.")
/*< 45>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		flw_268:
/*<268>*/ 		switch (loadzone_temp_flags[20 /* 0xB 10 */]) {
          		  case 0:
...
/*<189>*/ 	start()
/*<190>*/ 	printf("A report, ______Master. My analysis of this\nenemy's movement patterns is\ncomplete.\n\nWould you like to hear my analysis\nnow?\n[1]Yes.[2-]No.")
...
/*< 82>*/ 					printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          	  ...
          	  case 1:
/*<193>*/ 		printf("Understood, Master. If you wish to\nhear my analysis later, simply hold (Z) \nto lock on to the enemy and then press\n(v) to call me.__________")
          	}
          }

          void entrypoint_006_663() {
/*<194>*/ 	start()
/*<195>*/ 	printf("A report, ______Master. My analysis of this\nenemy's movement patterns is\ncomplete.\n\nWould you like to hear my analysis\nnow?\n[1]Yes.[2-]No.")
/*<196>*/ 	story_flags[778 /* us: 805A9B2D 0x04, jp: 805ACDAD 0x04 */] = true;
/*<197>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		goto flw_239
          	  case 1:
/*<198>*/ 		printf("Understood, Master. If you wish to\nhear my analysis later, simply hold (Z) \nto lock on to the enemy and then press\n(v) to call me.__________")
          	}
          }

          void entrypoint_006_664() {
/*<199>*/ 	start()
/*<200>*/ 	printf("A report, ______Master. My analysis of this\nenemy's movement patterns is\ncomplete.\n\nWould you like to hear my analysis\nnow?\n[1]Yes.[2-]No.")
/*<201>*/ 	story_flags[779 /* us: 805A9B2D 0x08, jp: 805ACDAD 0x08 */] = true;
/*<202>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		goto flw_240
          	  case 1:
/*<203>*/ 		printf("Understood, Master. If you wish to\nhear my analysis later, simply hold (Z) \nto lock on to the enemy and then press\n(v) to call me.__________")
          	}
          }
...
/*<278>*/ 						printf("You have defeated _______ of this type of\nenemy. My analysis shows that your\nbattle performance rating with this\nenemy is ______.")
          			  ...
          			  case 1:
/*<282>*/ 				printf("I have observed that it has a tendency\nto move with its back toward its prey\nto prevent its weak point from being\nexposed.\nTherefore, you must find a way to flip\nthe beast over to access its weak point.")
...
/*<253>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_116
          			  case 1:
/*<288>*/ 				printf("He is now revealing his true power.\nI am detecting a significant increase\nin muscular strength.\n\nUnfortunately, I must also conclude\nthat none of your weapons will be\neffective against him.\n[1]Tell me more![2-]Got it.")
/*<289>*/ 				switch (choice(2, 0)) {
          				  case 0:
/*<290>*/ 					printf("Analysis indicates that attacks from\nyour sword <r<may drive Ghirahim back>>,\nif ever so slightly, ______Master.\n[1]More info![2-]Got it.")
/*<291>*/ 					switch (choice(2, 0)) {
          					  case 0:
/*<292>*/ 						printf("I have noted that Ghirahim has a\ntendency to stand near the center of\nthe platform, ______Master.\n\nThere is an 85% probability he does\nthis to avoid falling off.\n[1]More info![2-]Got it.")
/*<293>*/ 						switch (choice(2, 0)) {
          						  case 0:
/*<119>*/ 							printf("This is all the information I have at\nthe present time.\n\n\nWhen I have more information to\nreport, ______Master, your sword will flash.\nYou can always press (v) to call on me._____\n\nFurthermore, when you require\ninformation about your equipment or\nyour surroundings, please select\n<r<Analysis>>.")
          						  case 1:
          						}
          					  case 1:
          					}
          	  ...
          	  case 1:
/*<218>*/ 		printf("Understood, Master. If you wish to\nhear my analysis later, simply hold (Z) \nto lock on to the enemy and then press\n(v) to call me.__________")
          	}
          }

          void entrypoint_006_651() {
/*<115>*/ 	start()
/*<117>*/ 	printf("There is a 90% change in outward\nappearance compared to previous\nencounters with him. I detect a dark\naura emanating from his entire body.\nBe cautious, ______Master. This opponent is \nextremely dangerous and likely to\nfell you with a single blow.\n[1]Tell me more.[2-]Understood.")
/*<118>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		goto flw_238
          	  case 1:
          	}
...
/*<219>*/ 	start()
/*<220>*/ 	printf("A report, ______Master. My preliminary\nanalysis of <b<Demise>> is now complete.\nWould you like to hear what I have\ndiscovered?\n[1]Yes.[2-]No.")
/*<221>*/ 	story_flags[783 /* us: 805A9B2D 0x80, jp: 805ACDAD 0x80 */] = true;
/*<222>*/ 	switch (choice(2, 0)) {
          	  case 0:
/*<232>*/ 		printf("It is clear that <r<Skyward Strikes >>cannot\nbe called down to your sword because\nthis place is under the magical\ninfluence of Demise.\nAttacks using <r<Skyward Strike energy\n>>will not be possible here.\n[1]Tell me more.[2-]Got it.")
/*<233>*/ 		switch (choice(2, 0)) {
          		  case 0:
/*<225>*/ 			printf("It is highly probable that the only\nweapon capable of wounding Demise\nis the <y<Master Sword >>itself. No other\nweapon can affect it.\n[1]Tell me more![2-]Got it.")
/*<226>*/ 			switch (choice(2, 0)) {
          			  case 0:
/*<227>*/ 				switch (scene_flags[120 /* 0xE 01 */]) {
          				  case 0:
/*<228>*/ 					printf("I can confirm it is possible for Demise\nto store the electrical energy of a\nlightning strike in his sword and use it\nto his advantage.\n______Master, should your sword come into\ncontact with Demise's sword once it\nhas electrified, you will receive a\npainful shock.[1]Tell me more.[2-]Understood.")
/*<230>*/ 					switch (choice(2, 0)) {
          					  case 0:
          						flw_229:
/*<229>*/ 						printf("I need more time to complete my\nanalysis of Demise.\n\n\nIn a few moments, use (Z) to lock on to\nDemise, and then call me with (v).\nI will report my findings then.__________")
          					  case 1:
          					}
          				  case 1:
          					goto flw_229
          	  ...
          	  case 1:
/*<223>*/ 		printf("Understood, Master. If you wish to\nhear my analysis later, simply hold (Z) \nto lock on to the enemy and then press\n(v) to call me.__________")
          	}
          }
