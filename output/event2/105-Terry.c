...
/*< 35>*/ 	switch (story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */]) {
          	  case 0:
          		flw_5:
/*<  5>*/ 		printf("Oh no! You don't have enough Rupees!\nLook at my face. If that's your idea of\na joke, I'm not laughing!")
/*<151>*/ 		loadzone_temp_flags[10 /* 0x8 04 */] = false;
/*<152>*/ 		loadzone_temp_flags[11 /* 0x8 08 */] = false;
          	  case 1:
/*<169>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
          			goto flw_5
          		  case 1:
/*< 32>*/ 			loadzone_temp_flags[1 /* 0x9 02 */] = true;
          			goto flw_5
          		}
          	}
          }
...
/*<  7>*/ 	switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 11), ('param4', 2), ('param5', 0)])) {
          	  case 0:
/*<  8>*/ 		printf("Oh! Thank you ever so much! You've\ngiven me the strength to keep pedaling!")
          		flw_33:
/*< 33>*/ 		loadzone_temp_flags[1 /* 0x9 02 */] = false;
/*< 34>*/ 		story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */] = true;
/*<200>*/ 		scene_flags[0 'Skyloft'][16 /* 0x3 01 */] = true;
/*<156>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 105), ('param2', 11), ('next', -1), ('param3', 7)])
          	  case 1:
/*<  9>*/ 		printf("Oh! It really suits you!")
          		goto flw_33
          	}
          }
...
/*< 37>*/ 	switch (story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */]) {
          	  case 0:
          		flw_11:
/*< 11>*/ 		printf("Oh! Please take a look at the other\nthings I have for sale.")
/*<153>*/ 		loadzone_temp_flags[10 /* 0x8 04 */] = false;
/*<154>*/ 		loadzone_temp_flags[11 /* 0x8 08 */] = false;
          	  case 1:
/*<170>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
          			goto flw_11
          		  case 1:
/*< 36>*/ 			loadzone_temp_flags[1 /* 0x9 02 */] = true;
          			goto flw_11
          		}
          	}
          }
...
/*< 94>*/ 		story_flags[478 /* us: 805A9B11 0x04, jp: 805ACD91 0x04 */] = true;
          		flw_157:
/*<157>*/ 		switch (loadzone_temp_flags[10 /* 0x8 04 */]) {
          		  case 0:
/*<158>*/ 			story_flags[746 /* us: 805A9B29 0x04, jp: 805ACDA9 0x04 */] = true;
          			flw_159:
/*<159>*/ 			switch (loadzone_temp_flags[11 /* 0x8 08 */]) {
          			  case 0:
...
/*<132>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 131), ('param3', 39)])
...
/*<108>*/ 				printf("Yes, can I help you? Ah... Pray,\nyou have something to show me?")
/*<128>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 2), ('param2', 0), ('next', 118), ('param3', 39)])
/*<118>*/ 				printf("______Ohh! You really did find my precious\n<b<Horned Colossus Beetle>>?!")
...
/*<121>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 0), ('next', 119), ('param3', 39)])
/*<119>*/ 				printf("______You found him! My dear bug, I thank\nyou from the bottom of my heart!\n\n\nNext time you enter my shop, I demand \nyou take any one of my items for half\noff the listed price!\n\n______It's just my way of saying thank you!")
...
/*< 99>*/ 				switch (scene_flags[14 /* 0x0 40 */]) {
          				  case 0:
/*<111>*/ 					switch (loadzone_temp_flags[4 /* 0x9 10 */]) {
          					  case 0:
