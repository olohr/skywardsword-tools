...
/*< 30>*/ 	start()
/*< 31>*/ 	printf("_____dYou don't have to tell me twice, zrrbt!")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf("I have located a substance that closely\nresembles the material used in the\nfortune-teller's crystal ball... It should\nmake a suitable replacement.\nShall I call the robot to collect it?\n[1]Yes.[2-]Not now.")
/*<  2>*/ 	switch (choice(2, 0)) {
          	  case 0:
/*<  4>*/ 		printf("______Master, I will send word to the robot\nusing telepathic transmission.")
          	  case 1:
/*<  3>*/ 		printf("Yes, ______Master. If you change your mind\nand decide to retrieve it, please\nexamine it again.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("_____dMistress Fi! I'm heeeeereeeee, zrrpt!\n\n\n\nOh. You want me to carry this old\nthing, bzzt?")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("_____dHey, Master Shortpants! How come\nyou always get the easy jobs, zrrpt?")
          }
