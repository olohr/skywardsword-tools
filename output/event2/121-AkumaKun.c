...
/*< 80>*/ 	printf("Won't you please gather <y<Gratitude\nCrystals >>and show them to me?\n[1]Sure![2-]Nope.")
/*<  5>*/ 	switch (choice(2, 0)) {
          	  case 0:
          		flw_82:
...
/*< 58>*/ 									switch (scene_flags[75 /* 0x8 08 */]) {
          									  case 0:
/*< 35>*/ 										switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 6), ('param3', 14), ('param4', 2), ('param5', 18)])) {
          										  case 0:
/*< 98>*/ 											OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 9), ('param2', 3083), ('next', 36), ('param3', 13)])
/*< 36>*/ 											printf("Oh, my! You've gathered <r<80>> <y<Gratitude\nCrystals>>! If I'm not mistaken, that's all\nthe Gratitude Crystals in the whole\nwonderful world!\n______Thank you! Thank you ever so much!\n\n\n\nPlease accept this final gift with all\nof my gratitude.")
          											flw_166:
/*<166>*/ 											OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 0), ('next', 37), ('param3', 12)])
/*< 37>*/ 											give_item(111 0x6F);
/*< 20>*/ 											printf("This is an embarrassingly small token\nof my gratitude, but I hope it will be\nuseful to you.")
/*< 87>*/ 											OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 9), ('param2', 3072), ('next', 15), ('param3', 13)])
/*< 15>*/ 											printf("Oh, dear... With this, I now have all the\n<y<Gratitude Crystals>> I require to\nbecome human!\n\n______I wonder if I'll really be able to make\nthe transformation... My heart is\naflutter!")
/*<148>*/ 											scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          										  case 1:
/*< 62>*/ 											printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<80 >>of them!")
          										}
          									  case 1:
/*< 34>*/ 										switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 5), ('param3', 14), ('param4', 2), ('param5', 16)])) {
          										  case 0:
/*< 59>*/ 											printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
          											flw_127:
/*<127>*/ 											OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 1), ('next', 161), ('param3', 12)])
/*<161>*/ 											give_item(33 0x21);
/*<162>*/ 											printf("______But that's not all I want you to have.\nGoodness, no. I have so much more\nthanks to give!\n\n______Here, take this too!")
/*<163>*/ 											give_item(33 0x21);
/*< 60>*/ 											printf("I only require a few more <y<Gratitude\nCrystals>> to become human. Please\nhelp this needy demon a bit more...")
/*< 61>*/ 											scene_flags[0 'Skyloft'][75 /* 0x8 08 */] = true;
/*<143>*/ 											switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 6), ('param3', 14), ('param4', 2), ('param5', 60)])) {
          											  case 0:
/*<144>*/ 												printf("______Oh, you're back! And it does appear \nyou've gathered more <y<Gratitude\nCrystals>>!\n\nOh, my! You've gathered <r<80>> <y<Gratitude\nCrystals>>! If I'm not mistaken, that's all\nthe Gratitude Crystals in the whole\nwonderful world!\n______Thank you! Thank you ever so much!\n\n\n\nPlease accept this final gift with all\nof my gratitude.")
          												goto flw_166
          											  case 1:
/*<147>*/ 												scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          											}
          										  case 1:
/*< 57>*/ 											printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<70 >>of them!")
          										}
          									}
          								  case 1:
/*< 33>*/ 									switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 4), ('param3', 14), ('param4', 2), ('param5', 14)])) {
          									  case 0:
/*< 28>*/ 										printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
          										flw_165:
/*<165>*/ 										OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 0), ('next', 27), ('param3', 12)])
/*< 27>*/ 										give_item(110 0x6E);
/*< 29>*/ 										printf("I only require a few more <y<Gratitude\nCrystals>> to become human. Please\nhelp this needy demon a bit more...")
/*< 56>*/ 										scene_flags[0 'Skyloft'][74 /* 0x8 04 */] = true;
/*<141>*/ 										switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 5), ('param3', 14), ('param4', 2), ('param5', 58)])) {
          										  case 0:
/*<142>*/ 											printf("______Oh gracious me! That is a prodigious\nquantity of <y<Gratitude Crystals>> you've\nbrought for me!\n\n______This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          											goto flw_127
          										  case 1:
/*<146>*/ 											scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          										}
          									  case 1:
/*< 54>*/ 										printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<50 >>of them!")
          									}
          								}
          							  case 1:
/*< 32>*/ 								switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 3), ('param3', 14), ('param4', 2), ('param5', 12)])) {
          								  case 0:
/*< 50>*/ 									printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
          									flw_164:
/*<164>*/ 									OrderedDict([('type', 'type3'), ('subType', 6), ('param1', 0), ('param2', 1), ('next', 49), ('param3', 12)])
/*< 49>*/ 									give_item(33 0x21);
/*< 51>*/ 									printf("You have made such magnificent\nprogress gathering <y<Gratitude Crystals>>.\n\n\nPlease just continue helping me a bit\nlonger...")
/*< 53>*/ 									scene_flags[0 'Skyloft'][73 /* 0x8 02 */] = true;
/*<139>*/ 									switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 4), ('param3', 14), ('param4', 2), ('param5', 56)])) {
          									  case 0:
/*<140>*/ 										printf("______Oh gracious me! That is a prodigious\nquantity of <y<Gratitude Crystals>> you've\nbrought for me!\n\n______This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          										goto flw_165
          									  case 1:
/*<145>*/ 										scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          									}
          								  case 1:
/*< 48>*/ 									printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<40 >>of them!")
          								}
          							}
          						  case 1:
/*< 31>*/ 							switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 2), ('param3', 14), ('param4', 2), ('param5', 10)])) {
          							  case 0:
/*< 25>*/ 								printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
          								flw_24:
/*< 24>*/ 								give_item(109 0x6D);
/*< 26>*/ 								printf("You have made such magnificent\nprogress gathering <y<Gratitude Crystals>>.\n\n\nPlease just continue helping me a bit\nlonger...")
/*< 47>*/ 								scene_flags[0 'Skyloft'][72 /* 0x8 01 */] = true;
/*<137>*/ 								switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 3), ('param3', 14), ('param4', 2), ('param5', 54)])) {
          								  case 0:
/*<138>*/ 									printf("______Oh gracious me! That is a prodigious\nquantity of <y<Gratitude Crystals>> you've\nbrought for me!\n\n______This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          									goto flw_164
          								  case 1:
/*< 99>*/ 									scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          								}
          							  case 1:
/*< 64>*/ 								printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<30 >>of them!")
          							}
          						}
          					  case 1:
/*< 30>*/ 						switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 1), ('param3', 14), ('param4', 2), ('param5', 8)])) {
          						  case 0:
/*< 43>*/ 							printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
          							flw_42:
/*< 42>*/ 							give_item(94 0x5E);
/*< 44>*/ 							printf("I'm still going to need more <y<Gratitude\nCrystals>> to become a human.\n\n\nPlease, won't you aid a poor,\nunfortunate demon in need?")
/*< 45>*/ 							scene_flags[0 'Skyloft'][71 /* 0x9 80 */] = true;
/*<135>*/ 							switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 2), ('param3', 14), ('param4', 2), ('param5', 52)])) {
          							  case 0:
/*<136>*/ 								printf("______Oh gracious me! That is a prodigious\nquantity of <y<Gratitude Crystals>> you've\nbrought for me!\n\n______This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          								goto flw_24
          							  case 1:
          							}
          						  case 1:
/*< 40>*/ 							printf("______Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <y<Gratitude Crystals>>!\n\nNext, come and see me when you've\ngathered <r<10 >>of them!")
          						}
          					}
          				  case 1:
/*< 63>*/ 					switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 0), ('param3', 14), ('param4', 2), ('param5', 32)])) {
          					  case 0:
/*< 22>*/ 						printf("______Oh! You've gathered quite a lot of\n<y<Gratitude Crystals>>, haven't you?\nHow magnificent!\n\n______Please take this as a token of this\ndemon's deepest appreciation!")
/*< 21>*/ 						give_item(108 0x6C);
/*< 23>*/ 						printf("I'm still going to need more <y<Gratitude\nCrystals>> to become a human.\n\n\nPlease, won't you aid a poor,\nunfortunate demon in need?")
/*< 38>*/ 						scene_flags[0 'Skyloft'][70 /* 0x9 40 */] = true;
/*<133>*/ 						switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 1), ('param3', 14), ('param4', 2), ('param5', 50)])) {
          						  case 0:
/*<134>*/ 							printf("______Oh gracious me! That is a prodigious\nquantity of <y<Gratitude Crystals>> you've\nbrought for me!\n\n______This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          							goto flw_42
          						  case 1:
          						}
          					  case 1:
/*<132>*/ 						switch (loadzone_temp_flags[1 /* 0x9 02 */]) {
          						  case 0:
          							flw_122:
/*<122>*/ 							switch (story_flags[329 /* us: 805A9AFF 0x80, jp: 805ACD7F 0x80 */]) {
          							  case 0:
/*< 14>*/ 								printf("______Oh, dear, I want to be a human so\nbadly it pains me! Please hurry along\nand gather some <y<Gratitude Crystals>>...\n\nJust come and show me <r<five >>to start\nwith. If you do a great kindness for\nsomeone, you may even get several\nat once!")
          							  case 1:
/*<123>*/ 								printf("______That dear girl should be back home\nsafe and sound by tomorrow morning.\nGive her parents my warmest regards\nwhen you see them.\nOh, and good luck gathering the\n<y<Gratitude Crystals >>I require. To start,\nplease bring me <r<five>> if you can!\nThat would be so splendid!\nIf you do a great kindness for someone,\nyou may even find several at once!")
          							}
          						  case 1:
...
/*<128>*/ 							switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 46)])) {
          							  case 0:
/*<130>*/ 								printf("______Magnificent! Yes, that is truly a\n<y<Gratitude Crystal>>!_____ That did not take\nyou long at all.\n\nAs a start, can you please bring me\n<r<five>> of them?\n\n\nIf you do a great kindness for someone,\nyou may even get several of them at\nonce!")
...
/*< 18>*/ 	printf("______It's...aghh!____<_")
...
/*< 68>*/ 	printf("___________Graaauuugh!______")
