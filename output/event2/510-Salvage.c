          void entrypoint_510_01() {
          	start()
/*<  1>*/ 	printf("This is the <r<Windmill Propeller >>you\nwere searching for.\n\n\nIt is now possible to retrieve this using\nthe robot whose services we have\nenlisted.\n\nWould you like me to call the robot?\n[1]Yes.[2-]No.")
/*<  2>*/ 	switch (choice(2, 0)) {
          	  case 0:
/*<  4>*/ 		printf("I will send word to the robot using\ntelepathic transmission, ______Master.")
          	  case 1:
...
/*<  5>*/ 	start()
/*<  6>*/ 	printf("_____dMistress Fi! I hope you weren't waiting\nlong, bzzzt!\n\n\nSo, zrrrbt, you want me to carry this?!")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("_____dI'll be waiting for you up in the sky,\nso don't take too long, vrrrt!")
          }

          void entrypoint_510_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("______Master, I suggest that we also return to\nthe sky and collect the propeller as\nsoon as possible.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("_____dHey! Master Shortpants! You're in my\nway here, zrrpt! I said, get out of the\nway, vrrrrrt!")
          }
