		  ...
		  case 0:
			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 1), ('param3', 9), ('param4', 2), ('param5', 2)])) {
			  case 0:
				...
				switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 2), ('param3', 9), ('param4', 2), ('param5', 4)])) {
				  case 0:
					switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 3), ('param3', 9), ('param4', 2), ('param5', 6)])) {
					  case 0:
						switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 4), ('param3', 9), ('param4', 2), ('param5', 8)])) {
						  case 0:
								  ...
								  case 0:
									switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 7), ('param3', 9), ('param4', 2), ('param5', 18)])) {
									  case 0:
										...
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 25), ('next', 52), ('param3', 29)])
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 25), ('next', 53), ('param3', 29)])
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 7), ('param2', 25), ('next', 40), ('param3', 29)])
										flw_40:
									  ...
									  case 1:
										...
										OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 7), ('param2', 25), ('next', 40), ('param3', 28)])
										goto flw_40
									}
								  case 1:
									printf("I suggest using smart tactics to your\nadvantage. Try #####leaving easy-to-collect\ntears #####for when you are being pursued.")
									OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 25), ('next', 40), ('param3', 28)])
									goto flw_40
								}
							  case 1:
								...
								OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 25), ('next', 40), ('param3', 28)])
								goto flw_40
							}
						  case 1:
							...
							OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 4), ('param2', 25), ('next', 40), ('param3', 28)])
							goto flw_40
						}
					  case 1:
						...
						OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 25), ('next', 40), ('param3', 28)])
						goto flw_40
					}
				  case 1:
					...
					OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 2), ('param2', 25), ('next', 57), ('param3', 28)])
					goto flw_57
				}
			  case 1:
				printf("######Master ####.")
				...
				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 25), ('next', 57), ('param3', 28)])
				goto flw_57
			}
		  case 1:
			printf("######Master ####.")
