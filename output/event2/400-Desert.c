...
/*<167>*/ 	start()
/*<168>*/ 	printf("We have arrived at the <b<Temple of\nTime>>.\n\n\nYou can use your dowsing ability to\nlocate the entrance to the trial you\nmust pass to open the way to the\nsacred flame.")
...
/*<283>*/ 			OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', -1), ('param3', 42)])
          		  case 1:
/*<  6>*/ 			switch (OrderedDict([('type', 'switch'), ('subType', 0), ('param2', 0), ('param3', 14), ('param4', 2), ('param5', 2)])) {
          			  case 0:
/*<277>*/ 				printf("______Thank you, zrrt!")
/*<278>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 0), ('next', 279), ('param3', 47)])
/*<279>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 6), ('param2', 0), ('next', 281), ('param3', 39)])
...
/*<  7>*/ 				printf("______If you hadn't come along, they would\nhave sucked all of the electricity out\nof me, vrrm!\n\nOh..._____ Look at that, zrrpt... You have a\n<y+<____5>>. It appears to be an older model\nof Lanayru fabrication.\n\nAs thanks for saving me, I will upgrade \n<r<that>> for you, zwooop. ______Give it here for a\nsecond, phwing!")
...
/*< 59>*/ 	printf("____Z_______A report, Master Link.\nWe have arrived at <b<Lanayru Mine>>.")
          }

          void entrypoint_400_68() {
/*<170>*/ 	start()
/*<172>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', -1), ('param2', 0), ('next', 171), ('param3', 39)])
/*<171>*/ 	printf("Congratulations, ______Master.")
/*<173>*/ 	printf("______You have completed the trial. You now\nhave the power to proceed to the sacred\nflame that will be entrusted to your\nsword and your strong spirit.")
/*<175>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 174), ('param3', 39)])
/*<174>*/ 	printf("The <y<_____ >>are one of the goddess's\nsacred gifts.\n\n\nYou can extend these claws attached to\nchains to pull yourself to <r<targets >>and\n<r<vines>> beyond your reach.")
/*<177>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', -1), ('param2', 0), ('next', 176), ('param3', 39)])
/*<176>*/ 	printf("The flame is somewhere in the desert...\nI conjecture that it lies in a place\nyou have not yet visited, ______Master.")
          }
...
/*<114>*/ 	printf("")
/*<159>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 1), ('param2', 0), ('next', 160), ('param3', 39)])
/*<160>*/ 	printf("")
/*<178>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', -1), ('param2', 0), ('next', 179), ('param3', 39)])
/*<179>*/ 	printf("")
          }
...
/*<205>*/ 	switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          	  case 0:
/*<206>*/ 		printf("__________Link! You made it into the\ndragon's territory?!____T\n\n\n___________I am so jealous!____Z\n\n\n\n___________You outdid me again, bud!")
          		flw_149:
...
/*<109>*/ 		switch (scene_flags[75 /* 0x8 08 */]) {
          		  case 0:
/*<111>*/ 			printf("______I found the passage that leads\nto where the <r<Thunder Dragon>> lives...____-\n\n\n___________But it is too narrow for a big guy like\nme to pass through. ___________If only there was a\nway...")
          			goto flw_149
          		  case 1:
...
/*<105>*/ 			switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          			  case 0:
/*<275>*/ 				printf("______Hello, hello, Link.")
/*<276>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 0), ('next', 108), ('param3', 39)])
/*<108>*/ 				printf("How is your search for that <b<sacred\nflame >>going? Did you find it?!\n\n\nI have been dying to hear whether you\nfound it. Well...did you?\n\n\n______._____._____._____So after that wild, long adventure,\nyou found it! ____Link, you\nare truly amazing.")
/*<358>*/ 				printf("______You know, I think it is time I tell you\nwhat I found out about the legend of\nthe three dragons.~~~\n\nI am certain there is a hidden area just\nbeyond here in the desert!\n\n\nYou see, I found a <r<narrow passageway>>______\nthat was too tight for me to fit through.\n\n\n______And my gut tells me that one of the\nthree dragons of legend, the <r<Thunder\nDragon>>, lives there!\n\n______These robots are connected to him\nsomehow. I am sure of it, bud.~~~\n\n\n<r<___________The T>><r<hunder Dragon>>, robots, and\nTimeshift Stones_____._____._____._____\n\n\n________________What an adventure!")
/*<107>*/ 				printf("______I just remembered, Link.\nI have got something to report on the\nexcavation project you invested in\nearlier!_____\nI found loads of Timeshift Stones!\n______Now I can pay you back 10 times what\nyou gave me!")
/*<106>*/ 				rupees += 100;
          				flw_285:
...
/*<110>*/ 				scene_flags[7 'Lanayru Desert'][75 /* 0x8 08 */] = true;
          				goto flw_149
          			  case 1:
/*<273>*/ 				printf("______Hello, hello, Link.")
/*<274>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 5), ('param2', 0), ('next', 211), ('param3', 39)])
/*<211>*/ 				printf("How is your search for that <b<sacred\nflame >>going? Did you find it?!\n\n\nI have been dying to hear whether you\nfound it. Well...did you?\n\n\n______._____._____._____So after that wild, long adventure,\nyou found it! ____Link, you\nare truly amazing.")
/*<359>*/ 				printf("______You know, I think it is time I tell you\nwhat I found out about the legend of\nthe three dragons.~~~\n\nI am certain there is a hidden area just\nbeyond here in the desert!\n\n\nYou see, I found a <r<narrow passageway>>______\nthat was too tight for me to fit through.\n\n\n______And my gut tells me that one of the\nthree dragons of legend, the <r<Thunder\nDragon>>, lives there!\n\n______These robots are connected to him\nsomehow. I am sure of it, bud.~~~\n\n\n<r<___________The T>><r<hunder Dragon>>, robots, and\nTimeshift Stones_____._____._____._____\n\n\n________________What an adventure!")
          				goto flw_285
          			}
          		}
          	}
...
/*<213>*/ 	start()
/*<214>*/ 	printf("A report, ______Master Link.")
...
/*<200>*/ 			OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 4), ('param2', 0), ('next', 199), ('param3', 39)])
/*<199>*/ 			OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', 100), ('next', 65), ('param3', 17)])
/*< 65>*/ 			printf("______Lanayru Mining Facility is just ahead.\nGood luck, vrrt!")
...
/*<102>*/ 	start()
/*<286>*/ 	printf("A report, ______Master. I can no longer\ndetect <b<Zelda>>'s aura.")
/*<287>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 7), ('param2', 0), ('next', 288), ('param3', 39)])
/*<288>*/ 	printf("The moment the gate was destroyed,\nZelda's presence disappeared from my\nreadings. ______<r<You can no longer search for\nher with your dowsing ability>>.")
/*<289>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', -1), ('param2', 0), ('next', 103), ('param3', 39)])
...
/*<130>*/ 	start()
/*<131>*/ 	printf("____Z_This arid region was transformed into\na desert over the course of several\nhundred years.")
          }
...
/*<132>*/ 	start()
/*<133>*/ 	printf("____Z_My projections show that <b<Zelda>> must\nhave traveled through this area.")
...
/*<138>*/ 	start()
/*<139>*/ 	printf("____Z_As a safety measure, I recommend\nyou <r<______check the terrain>> on your map\nwith _____. _____")
          }

          void entrypoint_400_79() {
/*<305>*/ 	start()
/*<306>*/ 	printf("______A report, Master Link.\n\n\n\nThe map you possess corresponds to the\nactual terrain of this area with only\n35% accuracy.\n\nThe robot you met earlier modified\nyour map to show <r<past terrain>>______ that is\nnow submerged below the sinksand.")
          }
...
/*<212>*/ 	printf("I recommend placing <b<multiple>>______ beacons.")
...
/*<146>*/ 	start()
/*<147>*/ 	printf("______________________Hey, you over there! Say, is that\nmy buddy Link?\nIt is!\n\n__________You have come at the perfect\ntime! ~~~I have something I want to\nshow you.~~~\n\n__________Come on up here!")
