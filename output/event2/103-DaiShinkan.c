...
/*< 67>*/ 	start()
/*< 68>*/ 	printf("______Quite a number of inexplicable things\nseem to be happening here...\n\n\nWhat might happen if you do as that\nstrange being asks?")
          }
...
/*< 47>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', -1), ('param3', 42)])
          	  case 1:
/*< 40>*/ 		printf("Yes, his knowledge is almost limitless,\nbut I fear meeting him may be harder\nthan you anticipate...")
          		goto flw_45
          	}
          }
