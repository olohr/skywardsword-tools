...
/*< 46>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x03Un árbol imperecedero...\n¿Dónde podríamos encontrar\nla <r<semilla >>de un árbol así?")
          					  case 1:
/*< 34>*/ 						printf(/* textboxtype: 1, unk: 0 */ "~~~.~~~.~~~.\x0E\x01\x09\x04\x0F\x803Hmmm.\n\n\n\n[1]¿Qué pasa?[2]Adiós")
/*< 35>*/ 						switch (choice(2)) {
          						  case 0:
/*< 36>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x703Oh, no tiene importancia...")
...
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 3, unk: 0 */ "\x0E\x01\x05\x04-\x00\x0E\x01\x08\x02\x2CD¡Despreciable mocoso!")
          }
