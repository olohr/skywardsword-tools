...
/*< 89>*/ 	start()
          	flw_67:
/*< 67>*/ 	set_camera(6, 0)
/*< 65>*/ 	printf(/* textboxtype: 2, unk: 2 */ "Al poner un pie fuera de este círculo,\nlos llamados <r<guardianes >>perseguirán\nal \x0E\x01\x12\x04\x00\x02amo.")
/*< 68>*/ 	set_camera(4, 0)
...
/*< 69>*/ 	set_camera(5, 0)
/*< 70>*/ 	printf(/* textboxtype: 2, unk: 2 */ "Para completar la <y<orquídea del\nespíritu>>, es necesario recoger todas\nlas <y<lágrimas >>sin sufrir ningún daño.")
          	flw_74:
/*< 74>*/ 	set_camera(1, 0)
/*< 75>*/ 	printf(/* textboxtype: 2, unk: 2 */ "¿Ha quedado todo claro, \x0E\x01\x12\x04\x00\x02amo?\n¿Es necesario que vuelva a repetir\nmi explicación?\n[1]Repítelo[2-]Entendido")
/*< 76>*/ 	switch (choice(2)) {
          	  case 0:
...
/*<  3>*/ 			printf(/* textboxtype: 2, unk: 2 */ "Esa es la <y<orquídea del espíritu>>.\n\n\n\nCuando la complete, el \x0E\x01\x12\x04\x00\x02amo habrá\nsuperado el juicio y verá fortalecido\nsu espíritu.\n\nEsto permitirá que la Diosa\nle conceda un <r<nuevo poder>>.")
          			flw_6:
