...
/*< 81>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x05¡Hola, guapetón!\n\n\n\n\x0E\x01\x09\x04\x0D\xF00Mmm... Eh... Verás...\n¿<r<Por qué no vienes esta noche\na mi casa>>? Tengo que hablar\ncontigo de algo importante.\n\x0E\x01\x09\x04\x08\xA00Vivo justo al lado del bazar, no tiene\npérdida. Vas a venir, ¿verdad que sí?\n¡Allí te espero!")
          								flw_79:
/*< 79>*/ 								printf(/* textboxtype: 1, unk: 0 */ "Bueno, ahora dime...\n¿Quieres dejar aquí algún objeto?\n\n[1]Por favor[2-]No, gracias")
...
/*< 62>*/ 				switch (choice(2)) {
          				  case 0:
/*< 64>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0D\xF0A¡No me mires así que me voy a\nsonrojar, <r<guapetón>>!")
          					flw_66:
...
/*< 68>*/ 					switch (choice(2)) {
          					  case 0:
/*< 67>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0F\x120EVeo que hoy tienes ganas de gastar\nbromas, ¿no? Ya está bien, guapetón.")
          						flw_70:
...
/*< 57>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Este... eh...\nBien... bienvenido...\n\n[1]¿Qué te\npasa?[2]Te veo\ndistinta")
/*< 56>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<399>*/ 	start()
/*<381>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1F0A\x309¡Te exijo que me pagues <r<unas 30 rupias\n>>como compensación, niño! \nEran piezas de gran valor... \n¡Y no creas que te estoy engañando!")
/*<382>*/ 	switch (random(4)) {
          	  case 0:
...
/*<360>*/ 	start()
/*<359>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1F0A\x309¡Me debes <r<unas 20 rupias>>, que esto\nera muy, muy valioso! ¡Y te aseguro\nque no te estoy engañando!")
/*<358>*/ 	switch (random(4)) {
          	  case 0:
...
/*<379>*/ 	start()
/*<361>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1F0A\x309Me debes <r<unas 10 rupias>>, niño,\n¡que esas piezas eran muy caras!\n¡Y no quiero excusas!")
/*<362>*/ 	switch (random(4)) {
          	  case 0:
...
/*<126>*/ 										switch (choice(2)) {
          										  case 0:
/*<128>*/ 											printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\xD07¡Estupendo! ¡Genial! Sabía que no\nme fallarías, Link.\n\n\n\x0E\x01\x09\x04\x01\xD00Intenta hacerlo cuanto antes,\n¿quieres? ¡Y gracias!")
...
/*<129>*/ 											loadzone_temp_flags[0 /* 0x1 01 */] = true;
          										  case 1:
/*<127>*/ 											printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\x90AVaya, Link, ¡y yo que\ncreía que ibas a ayudarme!...")
...
/*<118>*/ 									story_flags[574 /* us: 805A9B18 0x20, jp: 805ACD98 0x20 */] = true;
          							  ...
          							  case 1:
/*< 13>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\x90AVaya, Link, ¡y yo que\ncreía que ibas a ayudarme!...")
          								goto flw_122
          							}
          						  case 1:
...
/*< 25>*/ 	printf(/* textboxtype: 1, unk: 2 */ "Cocu, tranquilízate, por favor.\nNo hace falta que te pongas así.")
...
/*<424>*/ 			switch (OrderedDict([('type', 'switch'), ('subType', 6), ('param2', 0), ('param3', 7), ('param4', 2), ('param5', 188)])) {
          			  case 0:
          				flw_425:
/*<425>*/ 				rupees += -18;
/*<234>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1F0A\x300¡Si esto se repite, pienso tomar\nmedidas! ¡Estás avisado!")
          				flw_235:
