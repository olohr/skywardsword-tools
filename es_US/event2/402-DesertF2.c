...
/*<118>*/ 	start()
/*<122>*/ 	printf(/* textboxtype: 8, unk: 0 */ "Inclina el control en las curvas\npara equilibrar la vagoneta.")
          }
...
/*<214>*/ 				set_camera(15, 0)
/*<207>*/ 				printf(/* textboxtype: 1, unk: 0 */ "Si me ayudas, te llevaré conmigo\nen el bote.\n[1]De acuerdo[2-]Lo siento")
/*<215>*/ 				set_camera(-1, 0)
          				goto flw_134
          			  case 1:
          				goto flw_209
...
/*< 94>*/ 	start()
/*< 97>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Vamos, abre la <y<carta náutica >>que me\nhas traído, grumete.")
...
/*<110>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x00¡Adelante, a toda máquina!")
...
/*<286>*/ 				switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          				  case 0:
          					flw_275:
/*<275>*/ 					printf(/* textboxtype: 1, unk: 0 */ "Ay, grumete, qué feliz me hizo\nver mi galeón recién construido.\nCuántos recuerdos.~~.~~.")
          					flw_67:
...
/*<136>*/ 	printf(/* textboxtype: 1, unk: 2 */ "He marcado con una \x0E\x02\x04\x02\x19CD el lugar donde\nestá mi casa.\n\n\nEn la isla hay un <r<amarradero>>.\nPodemos atracar allí.")
/*< 89>*/ 	OrderedDict([('type', 'type3'), ('subType', 0), ('param1', 0), ('param2', 0), ('next', 88), ('param3', 34)])
/*< 88>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x00Adelante, ¡a toda máquina!")
