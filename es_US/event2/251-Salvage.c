...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00d¿Qué tal estás, Fay? ¡Perdona que\nte haya hecho esperar!\n\n\n¿Es esto lo que quieres que me lleve?")
          }

          void entrypoint_251_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Muy bien, estaré esperando en el cielo.\n¡Nos vemos luego, linda!")
          }

          void entrypoint_251_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x01Amo, sugiero regresar a Neburia\nde inmediato para llevar el kyu\na su destino.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00d¡Aparta, aparta!\n¡Tener que decírtelo siempre\nreduce la eficiencia!")
          }
...
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x05Sí, amo. Avisaré al robot\ntelepáticamente.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0 */ "\x0E\x01\x12\x04\x00\x05Está bien, amo. Si cambia de opinión,\nsugiero volver a examinarlo.")
          	}
          }
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x09\x13Y además, aquí hay enemigos por todas\npartes. ¡Esto está lleno de monstruos!\n\n\n\x0E\x01\x09\x04\x07\x04Qué dura es la vida de los kyus...")
          					goto flw_19
          				}
          			  case 1:
