...
/*< 28>*/ 							printf(/* textboxtype: 1, unk: 0 */ "Tíiiio, ¿pues para qué vienes a darme\nla brasa?\n\n\nContigo a bordo esto pesa más y tengo\nque echar el bofe pedaleando...")
...
/*<156>*/ 		entrypoint_105_11();
          	  case 1:
/*<  9>*/ 		printf(/* textboxtype: 1, unk: 0 */ "¡Tíiiio, no te arrepentirás de la compra\nque acabas de hacer!")
          		goto flw_33
          	}
          }
...
/*< 37>*/ 	switch (story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */]) {
          	  case 0:
          		flw_11:
/*< 11>*/ 		printf(/* textboxtype: 1, unk: 0 */ "No problem, pero echa un vistazo a mis\notros artículos, colega, hazme caso.\n")
...
/*< 57>*/ 							switch (choice(2)) {
          							  case 0:
/*< 60>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x11\x220¡¿En serio?!\n¡Te tomo la palabra, amigo mío!")
...
/*<110>*/ 								loadzone_temp_flags[4 /* 0x1 10 */] = true;
          							  case 1:
/*< 59>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01!¡Para ti es fácil decirlo porque te\nresbala todo, pero yo no puedo\nolvidarlo así como así!")
...
/*<126>*/ 							switch (story_flags[201 /* us: 805A9AEF 0x08, jp: 805ACD6F 0x08 */]) {
          							  case 0:
/*<125>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x1ESi quieres volver a Altárea, basta con\nque te eches en la cama a dormir.")
          								flw_98:
