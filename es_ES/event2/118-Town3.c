...
/*<283>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x06La madre de Cuqui andaba llamándola\na voz en grito hace un momento...\n¿Qué le habrá pasado?")
          				  case 1:
/*< 51>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0B\xE01¡Enhorabuena por la victoria en el\ntorneo celeste!\n\n\n\x0E\x01\x09\x04\x00\xA00Oye, vaya cara que traes...\n¿Te ha pasado algo?")
          				}
          			}
          		}
          	  case 1:
...
/*<195>*/ 	set_camera(4, 0)
/*<178>*/ 	set_camera(5, 0)
/*<176>*/ 	printf(/* textboxtype: 1, unk: 0 */ "La cosa es que lleva así, sin funcionar,\ndesde entonces.\n")
...
/*< 59>*/ 			switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          			  case 0:
/*< 61>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01He oído que has encontrado a Cuqui,\n¡qué bien!\n\n\n\x0E\x01\x09\x04\x0F\x1300Anda que... ya le vale, menudo susto\nnos ha dado.")
          			  case 1:
...
/*< 21>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x150F\xD00Por favor, Link, ayúdame\na buscarla, ¿quieres? Hace un buen\nrato que no la veo por ningún sitio...\n\n\x0E\x01\x09\x04\x1509\xD00He preguntado a todo el mundo,\ny parece ser que la han visto con\nun tipo de aspecto siniestro.\n\n\x0E\x01\x09\x04\x150B\xD00¡Hasta hay quien dice que la ha raptado\nun monstruo! ¡Ay! Ya no sé qué hacer...\n\n\n\x0E\x01\x09\x04\x150E\xD00¿Y si me han secuestrado a la niña?...\nClaro, con lo rica que es, habrá pasado\ncualquiera y se la habrá llevado...")
          			flw_22:
/*< 22>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1509\xD00¡Tienes que salvar a Cuqui, te lo\nsuplico! ¡La pobre tiene que estar\nmuerta de miedo!\n\n\x0E\x01\x09\x04\x150F\xD00Por favor, Link...\n[1]¡Descuida![2-]Ya lo\nsiento...")
/*< 23>*/ 			switch (choice(2)) {
          			  case 0:
...
/*<350>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1509\xD11¡Cuqui! ¡Cuqui!, ¿dónde estás?")
/*<357>*/ 	OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 5387), ('param2', 3328), ('next', 349), ('param3', 13)])
/*<349>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Ay, mi Cuqui, mi chiquitina...\n¿Dónde puede estar?...\n\n\n¿Y si se la ha llevado alguien?\n¿Qué voy a hacer?")
...
/*<443>*/ 			scene_flags[0 'Skyloft'][31 /* 0x2 80 */] = true;
          		  case 1:
/*<444>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x05Estoy entrenando por las noches para\nponerme hecho un toro como tú.")
          		}
          	  case 1:
...
/*<418>*/ 						switch (story_flags[836 /* us: 805A9B32 0x10, jp: 805ACDB2 0x10 */]) {
          						  case 0:
/*<419>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x05Estoy entrenando por las noches para\nponerme hecho un toro como tú.")
          							flw_332:
...
/*<339>*/ 								scene_flags[0 'Skyloft'][31 /* 0x2 80 */] = true;
          						  ...
          						  case 1:
/*<307>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01Si sigue la buena racha, seguro que\ntambién encuentras a Zelda en un\nperiquete.")
          							goto flw_332
          						}
          					  case 1:
...
/*<310>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\nVete a decírselo a su madre, ¡deprisa!\nEstará en casa hecha un manojo de\nnervios... Su casa está junto a la\nlaguna, creo.")
          					  case 1:
/*<309>*/ 						printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x12¡Link, Cuqui no aparece\nni a la de tres! Ya no sé dónde buscar... \n\n\n\x0E\x01\x09\x04\x00\xE10¿Seguro que tú también la estás\nbuscando? \n\n\n\x0E\x01\x09\x04\x00\xC00¡¿Cómo?! ¿Que ya la has encontrado?\n\n\n\n\x0E\x01\x09\x04\x07\xA0B¡Ay, qué alegría! ¡Por fin!\n¡Gracias, Link!\nMenos mal que has dado con ella... \n\nYa sabía yo que podía confiar en ti para\nencontrarla.\n")
...
/*<453>*/ 							switch (story_flags[7 /* us: 805A9AD8 0x01, jp: 805ACD58 0x01 */]) {
          							  case 0:
          								goto flw_454
          							  case 1:
/*<452>*/ 								printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01¡Voy a pasarme por la tienda de\nTerry para comprarme yo también\nun cazamariposas!\n\n¡Y cuando lo tenga iré a la chatarrería\npara que lo hagan más grande!")
          							}
          						}
          					}
          				}
...
/*<501>*/ 		switch (story_flags[206 /* us: 805A9AF0 0x04, jp: 805ACD70 0x04 */]) {
          		  case 0:
          			flw_505:
/*<505>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01¿Qué tal, Link?\n¿Sabes algo ya sobre el paradero de\nZelda? ¡Ojalá la encuentres pronto!")
          			goto flw_330
          		  case 1:
...
/*< 84>*/ 	switch (story_flags[324 /* us: 805A9AFF 0x04, jp: 805ACD7F 0x04 */]) {
          	  case 0:
/*< 85>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x13¡Rayos, pero si era el cachivache\nde Dorcon! ¡Menuda sorpresa!...")
...
/*<187>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0C\xC00¡Ya está, gorrión, otra vez como nuevo!\nSi quieres girar el molino entero, solo\ntienes que arreglártelas para mover\nel rotor.")
/*<210>*/ 		printf(/* textboxtype: 1, unk: 2 */ "\x0E\x01\x09\x04\x00\x100\x0E\x01\x08\x02\xFFCD¡Cariño!\n¡Cariñooo!")
/*<297>*/ 		switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          		  case 0:
/*< 90>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x05\x714¡Ahí va, mi parienta!\nSe me había olvidado que tenía que\narreglar la alacena de casa...\n\nEn mala hora se lo prometí. ¡La muy\ntirana siempre está endilgándole\ntareas a todo el mundo!")
/*< 91>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0C\xC00Bueno, Link, hasta otra...\n¡Nos vemos!")
          			flw_192:
...
/*<211>*/ 			OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', -1), ('next', -1), ('param3', 42)])
          		  case 1:
/*<295>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x05\x714Anda, ahora que caigo...\n¡Si se supone que estábamos buscando\na nuestra Cuqui!")
/*<296>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0C\xC00Bueno, Link, te dejo.\nPor cierto, si tienes tiempo, echa un\nvistazo a ver si encuentras a Cuqui\npor algún lado, ¿quieres?")
          			goto flw_192
          		}
          	  case 1:
...
/*< 82>*/ 	switch (story_flags[323 /* us: 805A9AFF 0x02, jp: 805ACD7F 0x02 */]) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 1, unk: 0 */ "¡Fay es un primor! Si ella me lo pide,\nno puedo negarme...\n")
          	  case 1:
...
/*<467>*/ 						printf(/* textboxtype: 2, unk: 0 */ "Entendido. Si el \x0E\x01\x12\x04\x00\x05amo cambia de\nopinión, solo tiene que hablar de nuevo\ncon este individuo.")
          				  ...
          				  case 1:
/*< 98>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x06\x02\xFCCDOh...\x0E\x01\x06\x02Í\x0E\x01\x09\x04\x0C\x1009 Vaya mundo este...\x0E\x01\x06\x02\xFCCD\nNo sé adónde vamos a llegar...\x0E\x01\x06\x02Í")
          				}
          			}
          		}
          	}
...
/*<233>*/ 							printf(/* textboxtype: 2, unk: 0 */ "Sí, \x0E\x01\x12\x04\x00\x05amo. Se ha cancelado el ajuste del\n<pling>rastreador. ")
          				  ...
          				  case 1:
/*<120>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x01¿Qué tal va la cosa?\n¿Has encontrado alguna nueva especie\nvegetal?\n")
          					goto flw_229
          				}
          			  case 1:
...
/*<137>*/ 	start()
/*<164>*/ 	printf(/* textboxtype: 1, unk: 0 */ "¡Aquí os dejo el <r<rotor>>!")
/*<108>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', 0), ('next', 86), ('param3', 33)])
/*< 86>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Si se ofrece cualquier otra cosa,\n¡ya sabéis dónde estoy!\n\n\nPor Fay iría hasta el fin del mundo...")
          }

          void entrypoint_118_19() {
/*<138>*/ 	start()
/*<139>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x09\x11Por el amor de kyu... Me da no sé qué\nque me mire tan fijamente...\n")
          }

          void entrypoint_118_20() {
/*<140>*/ 	start()
/*<125>*/ 	printf(/* textboxtype: 1, unk: 0 */ "¡Aquí traigo la bola de cristal esta\nque brilla tanto!")
/*<127>*/ 	OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', 0), ('next', 126), ('param3', 33)])
/*<126>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Si se ofrece cualquier otra cosa,\n¡ya sabéis dónde estoy!\n\n\nPor Fay iría hasta el fin del mundo...")
...
/*<  9>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x1509\xD11¡Cuqui! ¡Cuqui!, ¿dónde estás?")
/*<  8>*/ 	set_camera(2, 0)
/*<146>*/ 	OrderedDict([('type', 'type3'), ('subType', 4), ('param1', 5387), ('param2', 3328), ('next', 1), ('param3', 13)])
/*<  1>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Ay, mi Cuqui, mi chiquitina...\n¿Dónde puede estar?...\n\n\n¿Y si se la ha llevado alguien?\n¿Qué voy a hacer?")
