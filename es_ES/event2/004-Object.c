...
/*< 11>*/ 			printf(/* textboxtype: 5, unk: 1 */ "En la alforja no te cabe nada más y\nla <r<consigna >>también está llena.\n\n\nEl objeto se queda en el cofre.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 5, unk: 1 */ "¡La alforja está llena, así que el objeto te\nlo guardan en la <r<consigna>>!")
          		}
          	  case 1:
          	}
          }
...
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0 */ "El <r<dragón>> que habita en la cima del\nvolcán habla hasta con las paredes.\n\n\nSe dice que puede pasarse horas\ncharlando de tierras lejanas y\nparajes exóticos.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Dicen por ahí que en la cima de este\nvolcán vive un <r<dragón >>envuelto\nen llamas.\n\nY que vive en un <r<lugar tan abrasador\n>>que casi nadie puede acercarse.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 1 */ "¿Quieres que te lo cuente otra vez?\n\n[1]Sí[2-]No")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 1, unk: 1 */ "¿Ah, no?~~~ Pues tú mismo...")
          		}
          	}
          }
...
/*< 45>*/ 	start()
/*< 44>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Dicen por ahí que si dibujas un círculo\nen los muros misteriosos, aparece algo\ncon forma circular.")
          }
...
/*< 25>*/ 	start()
/*< 38>*/ 	printf(/* textboxtype: 1, unk: 0 */ "Dicen por ahí que si dibujas una flecha\nen los muros misteriosos, aparece\nun objeto de forma similar.")
          }
