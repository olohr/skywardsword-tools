...
/*<299>*/ 	switch (story_flags[360 /* us: 805A9B00 0x40, jp: 805ACD80 0x40 */]) {
          	  case 0:
/*<301>*/ 		printf(/* textboxtype: 2, unk: 0 */ "Pequeños animales típicos de <b<Altárea>>.\nDesde que <b<Batolo>> se volvió humano ya\nno se asilvestran al caer la noche.")
          	  case 1:
...
/*< 13>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 2, unk: 0 */ "Esta bestia es en realidad un <b<minigrad>>\nmuy desarrollado cuya edad ronda los\nmil años, de ahí que se lo conozca como\nel «Escorpión milenario».\nAl menos el 90% de su cuerpo está\nrecubierto por una dura coraza capaz\nde repeler cualquier ataque de espada.[1]Más\ndetalles[2-]¡Gracias!")
/*< 16>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_17
          	  case 1:
...
/*< 33>*/ 	start()
/*< 35>*/ 	printf(/* textboxtype: 2, unk: 0 */ "Todo su cuerpo está recubierto de rocas\nincandescentes, con las que oculta su\n<r<ojo>>, el único punto débil de su cuerpo.\n\nSi se lograse eliminar toda la capa\nde piedras que cubre su piel, las\nposibilidades de éxito aumentarían\nsustancialmente.[1]Más\ndetalles[2-]¡Gracias!")
/*< 36>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_231
          	  case 1:
