...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dFay, ricura, ¿me llamabas?\n\n\n\nMmm, este lugar tiene un aire\nextrañamente familiar...\n\n\nBueno, da lo mismo, estamos aquí\npara trabajar. Esto es lo que quieres\nque me lleve, ¿verdad?")
          }

          void entrypoint_451_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dPues nada, me lo llevo volando.\nTe espero surcando los cielos,\nbombón. ¡No me tardes!")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x12\x04\x00dTú no te estreses, amo verdoso.\nDeja que trabajemos los profesionales.")
          }
