...
/*< 84>*/ 				switch (temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*< 85>*/ 					printf(/* textboxtype: 1, unk: 1 */ "\x0E\x01\x09\x04\x00\x02Qué... ¿te ves con fuerzas para otra\nronda? ¡Son solo<r< 20 rupias>>!\n[1]¡Vale![2]¿Cómo iba?[3-]Mejor no")
          					flw_74:
/*< 74>*/ 					switch (choice(3)) {
          					  case 0:
          						flw_67:
/*< 67>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*< 68>*/ 							rupees += -20;
/*< 70>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\xA0A¡Pues vamos allá!\n¡Ánimo, Link!")
/*< 71>*/ 							OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', 0), ('next', -1), ('param3', 33)])
          						  case 1:
          							flw_66:
/*< 66>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\x811Andas corto de dinero... Se ve que tú\ntambién pasas tus estrecheces,\n¿eh, Link?...")
          						}
          					  case 1:
          						flw_63:
...
/*< 37>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\x800\x0E\x01\x08\x02\xFFCDEsto...\x0E\x01\x04\x02\x14 Verás...\n\n\n\n\x0E\x01\x09\x04\x07\x800Bueno, nada...\x0E\x01\x04\x02\x14\nDéjalo, no te preocupes.")
          }
...
/*<114>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x01\x200Si se te olvidan los controles, puedes\nvolver a consultarlos siempre que\nquieras <g<pulsando>> <g<(2)>>.\x0E\x01\x11\x02\x5CD\n\nAsí verás una lista de las acciones y los\ncontroles posibles en cada momento.\n¡Verás lo práctico que es!")
          		  case 1:
/*< 33>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x03Esto, Link...\n¿Me puedes echar una mano?\n[1]¡Claro![2-]Imposible")
/*< 34>*/ 			switch (choice(2)) {
          			  case 0:
/*< 35>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\xA0B¡Gracias! Verás...")
/*<  9>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x203Si me haces el favor, quisiera que le\nllevaras un <r<barril >>a la señora del\ncomedor.\n\nPuedes coger el barril con (A) y, si\npulsas (A) otra vez, lo <g<dejas >>en el\nsuelo; así de fácil.\n\n\x0E\x01\x09\x04\x01\x200También puedes <g<lanzar>> el barril si,\nmientras lo llevas a cuestas, <g<apuntas\ncon el mando hacia arriba y lo agitas>>.\n\nEn el caso de objetos pequeños, como\nun jarrón, puedes lanzarlos <g<rodando\n>>por el suelo <g<apuntando hacia abajo y\nagitando el mando>>.\n\x0E\x01\x09\x04\xC07\x200Pero es mejor que ni lo intentes,\nporque ese tipo de cosas se rompen\ncon facilidad...")
