...
/*< 92>*/ 	switch (story_flags[325 /* us: 805A9AFF 0x08, jp: 805ACD7F 0x08 */]) {
          	  case 0:
/*< 93>*/ 		printf(/* textboxtype: 1, unk: 1 */ "\x0E\x01\x09\x04\x00\x03¡Eh, chaval! ¿Qué tal te va con\nel Serbot? ¿Necesitas que te haga\nalgún arreglillo?\n[1]Mejorar[2]Escudo[3-]Nada")
          		flw_4:
/*<  4>*/ 		switch (choice(3)) {
          		  case 0:
/*< 31>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<  2>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x09¡Oído, cocina! Estos son los objetos\nque por ahora pueden mejorarse.")
/*<  5>*/ 				OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 0), ('param2', 0), ('next', -1), ('param3', 33)])
          			  case 1:
/*< 32>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0E\xE0CChaval, pero si no tienes ningún objeto\nque se pueda mejorar...\n\n\nAnda, vete a la tienda de utensilios y\ncómprate algo...")
          			}
          		  case 1:
...
/*< 40>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x03Chaval, ¿qué te pasa, que me traes\nesos ojillos de cordero degollado?\n\n\nEso es que quieres pedirme algo,\n¿verdad?\n[1]Pues sí...[2-]Qué va")
/*< 41>*/ 				switch (choice(2)) {
          				  case 0:
...
/*< 84>*/ 						switch (choice(2)) {
          						  case 0:
/*< 85>*/ 							printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x717¿Eh? ¿Que tú tienes una?\n¡Chaval, eres un fenómeno!")
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\x806Hale, ¡manos a la obra! Te aviso\nde que los cambios que haga son\npermanentes, ¿eh?\n[1]Tú dale[2-]Déjalo")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
/*<128>*/ 		OrderedDict([('type', 'type3'), ('subType', 1), ('param1', 3), ('param2', 0), ('next', 10), ('param3', 33)])
/*< 10>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x70E¡Oído, cocina! Estará listo en un pispás.")
...
/*< 26>*/ 		loadzone_temp_flags[4 /* 0x1 10 */] = true;
          	  case 1:
/*< 11>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0E\xE05¡Pero...! ¿Qué, te divierte mofarte\nde los pobres trabajadores, chaval?\n\n\n¡Anda, ve a pitorrearte de otro,\ngraciosillo!")
...
/*< 27>*/ 	switch (loadzone_temp_flags[4 /* 0x1 10 */]) {
          	  case 0:
/*< 28>*/ 		printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\x800¡Muchas gracias! Un placer hacer\nnegocios contigo.\x0E\x01\x09\x04\x00\x02")
...
/*<126>*/ 	set_camera(10, 0)
/*<129>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x160E\x200Te... ¿te llamas Fay? ¿Sí? Y, oye, ¿qué\ndecías que buscabas exactamente?")
...
/*< 20>*/ 	start()
/*< 22>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0E\xE0CChaval, no te llegan las rupias...\nLo siento, pero no hay mejora\nque valga.\n\n\x0E\x01\x09\x04\x07\x700Si hay alguna otra cosa a la que quieras\ndarle un repaso, soy todo oídos.")
...
/*< 73>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\x800Arreglar este escudo te sale por\n<r<10 rupias>>. ¿De acuerdo?\n[1]Sí[2-]Déjalo")
/*< 74>*/ 	switch (choice(2)) {
          	  case 0:
/*< 81>*/ 		switch (has_rupees(10)) {
          		  case 0:
/*< 83>*/ 			rupees += -10;
/*< 78>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x07\x70E¡Oído, cocina! Estará listo en un pispás.")
...
/*< 80>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x08\x809¡Terminado! Aquí tienes.")
          		  case 1:
/*< 82>*/ 			printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0E\xE0CChaval, no te llegan las rupias...\nAnda, vuelve cuando hayas ahorrado\nun poco.")
          		}
          	  case 1:
/*< 75>*/ 		printf(/* textboxtype: 1, unk: 0 */ "Muy bien, pues lo dejamos.\n¿Tienes otro escudo que\nquieras arreglar?")
...
/*<219>*/ 	start()
/*<222>*/ 	printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x0E\xE0C¡Va a ser que no, chaval!\nLo siento, pero te faltan materiales.\n¡No tienes suficiente <y<cristal maléfico>>!\n\nSegún los cuadernos de mi abuelo,\nlo puedes conseguir de unos monstruos\nde color muy oscuro...")
