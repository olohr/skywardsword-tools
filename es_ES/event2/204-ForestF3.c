...
/*<116>*/ 				switch (story_flags[78 /* us: 805A9AE8 0x80, jp: 805ACD68 0x80 */]) {
          				  case 0:
          					flw_119:
/*<119>*/ 					printf(/* textboxtype: 1, unk: 0 */ "<r<Explotar>> criaturas pinchudas es muy,\nmuy peligroso. Provocan gran onda\nexpansiva.")
          				  case 1:
...
/*<125>*/ 				switch (scene_flags[26 /* 0x2 04 */]) {
          				  case 0:
/*<137>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x09\x0CUtiliza el rastreo o lo que quieras,\n¡pero tienes que encontrar cuanto\nantes las faronitas!")
          				  case 1:
/*<126>*/ 					printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x00\x07¡Creo que el jefe te está llamando!\n¡Será mejor que vayas a ver qué quiere!")
          				}
          			  case 1:
/*<127>*/ 				printf(/* textboxtype: 1, unk: 0 */ "\x0E\x01\x09\x04\x09\x0C¿Que la <b<dragona del agua >>ha inundado\nel bosque? ¡Querrá un kyu pasado\npor agua para cenar!")
          			}
          		}
          	  case 1:
